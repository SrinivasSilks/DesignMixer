...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage rani = ImageIO.read(new File("z-vasu/in/1/design1/pallu/pallu_rani-1.bmp"));
        BufferedImage jari = ImageIO.read(new File("z-vasu/in/1/design1/pallu/pallu_jari-1.bmp"));
