...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/1/design4/anni-%s-%s.bmp";

        BufferedImage border = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-vasu/in/1/design4/border/border.bmp")));
