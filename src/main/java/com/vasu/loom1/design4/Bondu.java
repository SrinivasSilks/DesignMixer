package com.vasu.loom1.design4;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/1/design4/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/1/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/1/design4/kanni-1824-400.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/1/design4/anni-200-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/1/design4/pallu-1824-3840.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-vasu/out/1/design4/1brocade-1824-1800.bmp"));
...
//        inputBIs.add(brocade);
        ...
        inputBIs.add(pallu);
        inputBIs.add(CutLayoutGenerator.get(CutLayoutGenerator.get(anni, 20).get(1), 80).get(0));
