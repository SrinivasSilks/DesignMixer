package com.vasu.loom1.design4.brocade3;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage nimbu, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, String.format("z-vasu/out/1/design4/3brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage read = ImageIO.read(new File("z-vasu/in/1/design4/brocade3/jari2-22.bmp"));
