...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/1/design3/kanni-rani-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-vasu/in/1/design3/border/border.bmp")));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-vasu/in/1/design3/border/border-first.bmp"))));
