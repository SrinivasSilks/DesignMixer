package com.vasu.loom1.design7;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/1/design7/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/1/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/1/design7/kanni-1824-600.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/1/design7/anni-300-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/1/design7/pallu-1824-3840.bmp"));
