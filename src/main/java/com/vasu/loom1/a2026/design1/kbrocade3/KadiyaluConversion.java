package com.vasu.loom1.a2026.design1.kbrocade3;
...
public class KadiyaluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/1/2026/design1/A1KBRC3.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage right = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-vasu/in/1/2026/design1/border/border.bmp")));
        ...
        BufferedImage jari = VerticalRepeatGenerator.get(2, HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-vasu/in/1/2026/design1/brocade3/jari.bmp"))));
