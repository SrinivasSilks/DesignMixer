package com.vasu.loom1.a2026.design1.pallu;
...
import static com.vasu.loom1.a2024.TwoPlay.getBorder;
import static com.vasu.loom1.a2024.TwoPlay.getBrocade;
import static com.vasu.loom1.a2024.TwoPlay.jari;
import static com.vasu.loom1.a2024.TwoPlay.rani;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/1/2026/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage jari = ImageIO.read(new File("z-vasu/in/1/2026/design1/pallu/pallu_jari.bmp"));
        BufferedImage rani = PlainGenerator.get(jari.getWidth(), jari.getHeight());

        BufferedImage rightd = ImageIO.read(new File("z-vasu/in/1/2026/design1/border/border.bmp"));
        BufferedImage leftd = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/1/2026/design1/border/border.bmp")));
