package com.vasu.loom1.a2026.design1.kanni;
...
import static com.vasu.loom1.TwoPlay.getBorder;
import static com.vasu.loom1.TwoPlay.getBrocade;
import static com.vasu.loom1.TwoPlay.jari;
import static com.vasu.loom1.TwoPlay.rani;
...
public class KanniConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/1/2026/design1/kanni-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage left = HorizontalRepeatGenerator.get(1, VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/1/2026/design1/border/border.bmp"))));
