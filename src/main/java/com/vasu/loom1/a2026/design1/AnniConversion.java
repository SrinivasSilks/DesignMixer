...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/1/2026/design1/A1ANNI.bmp";

        BufferedImage border = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-vasu/in/1/2026/design1/border/border.bmp")));
