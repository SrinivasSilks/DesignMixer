...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/1/design2/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/1/design2/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/1/design2/kanni-1824-720.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/1/design2/anni-360-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/1/design2/pallu-1824-3440.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-vasu/out/1/design2/kbroc-1824-2160.bmp"));
