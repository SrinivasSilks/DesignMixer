...
public class BrocadeConversion {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage read = ImageIO.read(new File("z-vasu/in/1/design5/brocade3/jari.bmp"));
        BufferedImage readnimbu = ImageIO.read(new File("z-vasu/in/1/design5/brocade3/nimbu.bmp"));
