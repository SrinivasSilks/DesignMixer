package com.vasu.loom1.design6;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/1/design6/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/1/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/1/design6/kanni-1824-560.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/1/design6/anni-280-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/1/design6/pallu-1824-3840.bmp"));
