package com.vasu.loom1.a2024.design1;
...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/1/a2024/design1/anni-%s-%s.bmp";

        BufferedImage border = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-vasu/in/1/a2024/design1/border/right.bmp")));
