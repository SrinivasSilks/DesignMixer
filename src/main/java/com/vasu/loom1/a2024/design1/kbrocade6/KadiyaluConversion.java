package com.vasu.loom1.a2024.design1.kbrocade6;
...
public class KadiyaluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/1/a2024/design1/6kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage jari = VerticalRepeatGenerator.get(2, HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-vasu/in/1/a2024/design1/brocade6/jari.bmp"))));
