package com.vasu.loom1.design8.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/1/design8/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage rightd = ImageIO.read(new File("z-vasu/in/1/design8/border/border.bmp"));
        BufferedImage leftd = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/1/design8/border/border.bmp")));
        ...
        BufferedImage rani = ImageIO.read(new File("z-vasu/in/1/design8/pallu/pallu_rani.bmp"));
        BufferedImage jari = ImageIO.read(new File("z-vasu/in/1/design8/pallu/pallu_jari.bmp"));
