package com.vasu.loom3.design4;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/3/design4/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/3/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/3/design4/kanni-1824-760.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/3/design4/anni-380-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/3/design4/pallu-1824-3840.bmp"));
