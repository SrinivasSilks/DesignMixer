package com.vasu.loom3.design4.brocade4;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage nimbu, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, String.format("z-vasu/out/3/design4/4brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage jari = HorizontalRepeatGenerator.get(38, ImageIO.read(new File("z-vasu/in/3/design4/brocade4/jari.bmp")));
