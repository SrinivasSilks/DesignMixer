package com.vasu.loom3.a2024.kanni;
...
import static com.vasu.loom3.a2024.TwoPlay.*;
...
public class KanniConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/3/a2024/design1/kanni-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage right = ImageIO.read(new File("z-vasu/in/3/a2024/design1/border/right.bmp"));
        BufferedImage left = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/3/a2024/design1/border/left.bmp")));
