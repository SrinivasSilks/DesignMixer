package com.vasu.loom3.design5.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/3/design5/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage rightd = ImageIO.read(new File("z-vasu/in/3/design5/border/border.bmp"));
        BufferedImage leftd = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/3/design5/border/border.bmp")));

        BufferedImage rightf = HorizontalRepeatGenerator.get(10, rightd);
        BufferedImage right = CutLayoutGenerator.get(CutLayoutGenerator.get(rightf, 180, 1), 1920, 0);

        BufferedImage leftf = HorizontalRepeatGenerator.get(10, leftd);
        ...
        BufferedImage jari = ImageIO.read(new File("z-vasu/in/3/design5/pallu/pallu_jari.bmp"));
