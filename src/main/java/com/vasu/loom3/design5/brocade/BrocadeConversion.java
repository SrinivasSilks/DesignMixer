package com.vasu.loom3.design5.brocade;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage nimbu, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, String.format("z-vasu/out/3/design5/1brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage jari = HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-vasu/in/3/design5/brocade/jari.bmp")));
