...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/6/a2024/design2/1brc-jari-%s-%s.bmp";
        ...
        final BufferedImage pallu = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-vasu/in/6/a2024/design2/brocade1/jari.bmp")));
