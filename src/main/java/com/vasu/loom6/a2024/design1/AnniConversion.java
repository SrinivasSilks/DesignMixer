...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/6/a2024/design1/anni-%s-%s.bmp";

        List<BufferedImage> inputBIs = new LinkedList<>();

        final BufferedImage left = ImageIO.read(new File("z-vasu/in/6/a2024/design1/border/left.bmp"));
        final BufferedImage right = ImageIO.read(new File("z-vasu/in/6/a2024/design1/border/right.bmp"));
