package com.vasu.loom4.design5;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/4/design5/pset.bmp";
        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/4/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/4/design5/kanni-1824-480.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/4/design5/anni-240-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/4/design5/pallu-1824-3840.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-vasu/out/4/design5/1brocade-1824-3600.bmp"));
