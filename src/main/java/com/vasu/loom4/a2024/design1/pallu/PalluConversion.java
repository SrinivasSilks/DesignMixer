package com.vasu.loom4.a2024.design1.pallu;
...
import static com.vasu.loom4.a2024.TwoPlay.*;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/4/a2024/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage rightd = ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/right1.bmp"));
        BufferedImage leftd = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/left1.bmp")));

        BufferedImage jari = ImageIO.read(new File("z-vasu/in/4/a2024/design1/pallu/pallu_jari.bmp"));
