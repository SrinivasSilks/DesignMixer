...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/4/a2024/design1/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/4/a2024/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/4/a2024/design1/kanni-1824-760.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/4/a2024/design1/anni-380-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/4/a2024/design1/pallu-1824-3224.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-vasu/out/4/a2024/design1/1kbroc-1824-17100.bmp"));
