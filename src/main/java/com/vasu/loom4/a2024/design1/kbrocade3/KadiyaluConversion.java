...
public class KadiyaluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        BufferedImage right = HorizontalRepeatGenerator.get(30, ImageIO.read(new File("z-vasu/in/3/a2024/design1/border/right.bmp")));
        BufferedImage leftBack = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(30, ImageIO.read(new File("z-vasu/in/3/a2024/design1/border/left-first.bmp"))));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(30, ImageIO.read(new File("z-vasu/in/3/a2024/design1/border/left.bmp"))));

        BufferedImage jari = HorizontalRepeatGenerator.get(19, ImageIO.read(new File("z-vasu/in/3/a2024/design1/brocade3/jari.bmp")));
