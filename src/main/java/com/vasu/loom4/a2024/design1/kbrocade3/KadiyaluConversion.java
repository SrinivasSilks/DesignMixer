package com.vasu.loom4.a2024.design1.kbrocade3;
...
public class KadiyaluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/4/a2024/design1/3kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage right = HorizontalRepeatGenerator.get(30, ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/right1.bmp")));
        BufferedImage leftBack = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(30, ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/left1-first.bmp"))));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(30, ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/left1.bmp"))));

        BufferedImage jari = HorizontalRepeatGenerator.get(19, ImageIO.read(new File("z-vasu/in/4/a2024/design1/brocade3/jari.bmp")));
