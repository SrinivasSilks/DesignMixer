...
public class KadiyaluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        BufferedImage right = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/right1.bmp")));
        BufferedImage leftBack = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/left1-first.bmp"))));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-vasu/in/4/a2024/design1/border/left1.bmp"))));
