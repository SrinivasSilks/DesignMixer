package com.vasu.loom4.design4.brocade;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage nimbu, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, String.format("z-vasu/out/4/design4/1brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(String[] args) throws IOException {
        BufferedImage borderdf = ImageIO.read(new File("z-vasu/in/4/design4/border/border.bmp"));
        BufferedImage border = HorizontalRepeatGenerator.get(14, borderdf);
        BufferedImage jari = HorizontalRepeatGenerator.get(19, ImageIO.read(new File("z-vasu/in/4/design4/brocade/jari.bmp")));
