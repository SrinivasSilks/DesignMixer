package com.vasu.loom2.a2024.kbrocade9;
...
public class KadiyaluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/2/a2024/design1/9kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage jari = HorizontalRepeatGenerator.get(4, VerticalRepeatGenerator.get(2, ImageIO.read(new File("z-vasu/in/2/a2024/design1/brocade9/jari.bmp"))));
