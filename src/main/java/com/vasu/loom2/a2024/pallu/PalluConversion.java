package com.vasu.loom2.a2024.pallu;
...
import static com.vasu.loom2.a2024.TwoPlay.*;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/2/a2024/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage jari = ImageIO.read(new File("z-vasu/in/2/a2024/design1/pallu/pallu_jari.bmp"));
        BufferedImage rani = PlainGenerator.get(jari.getWidth(), jari.getHeight());

        BufferedImage rightd = ImageIO.read(new File("z-vasu/in/2/a2024/design1/border/right.bmp"));
        BufferedImage leftd = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/2/a2024/design1/border/left.bmp")));

        BufferedImage rightf = HorizontalRepeatGenerator.get(80, rightd);
        BufferedImage right = CutLayoutGenerator.get(CutLayoutGenerator.get(rightf, 180, 1), jari.getWidth(), 0);

        BufferedImage leftf = HorizontalRepeatGenerator.get(80, leftd);
