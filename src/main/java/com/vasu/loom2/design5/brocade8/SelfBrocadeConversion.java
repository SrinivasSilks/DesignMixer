package com.vasu.loom2.design5.brocade8;
...
public class SelfBrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/2/design5/8selfbrocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage image = ImageIO.read(new File("z-vasu/in/2/design5/brocade8/jari.bmp"));
        BufferedImage read = RightLayoutGenerator.get(HorizontalRepeatGenerator.get(2, LeftLayoutGenerator.get(image)));
        BufferedImage jari = HorizontalRepeatGenerator.get(8, read);

        BufferedImage image2 = ImageIO.read(new File("z-vasu/in/2/design5/brocade8/nimbu.bmp"));
        BufferedImage read2 = RightLayoutGenerator.get(HorizontalRepeatGenerator.get(2, LeftLayoutGenerator.get(image2)));
        BufferedImage rani = HorizontalRepeatGenerator.get(8, read2);
