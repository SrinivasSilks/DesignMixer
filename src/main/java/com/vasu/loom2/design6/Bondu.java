package com.vasu.loom2.design6;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/2/design6/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/2/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/2/design6/kanni-1824-560.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/2/design6/anni-280-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/2/design6/pallu-1824-3840.bmp"));
...
//        inputBIs.add(brocade);
        ...
        inputBIs.add(pallu);
        inputBIs.add(CutLayoutGenerator.get(CutLayoutGenerator.get(anni, 140).get(1), 80).get(0));
