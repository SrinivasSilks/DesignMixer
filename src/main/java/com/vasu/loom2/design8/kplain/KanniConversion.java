package com.vasu.loom2.design8.kplain;
...
public class KanniConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/2/design8/kplainanni-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage right = ImageIO.read(new File("z-vasu/in/2/design8/border/border.bmp"));
        BufferedImage left = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/2/design8/border/border.bmp")));
