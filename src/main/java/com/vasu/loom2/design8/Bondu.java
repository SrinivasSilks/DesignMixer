package com.vasu.loom2.design8;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/out/2/design8/pset.bmp";


        BufferedImage kongu = ImageIO.read(new File("z-vasu/out/2/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-vasu/out/2/design8/kanni-1824-720.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-vasu/out/2/design8/anni-360-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-vasu/out/2/design8/pallu-1824-3840.bmp"));
//        BufferedImage brocade = ImageIO.read(new File("z-vasu/out/2/design1/1brocade-1824-2160.bmp"));
