package com.vasu.loom2.design1.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-vasu/out/2/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage rightd = ImageIO.read(new File("z-vasu/in/2/design1/border/border.bmp"));
        BufferedImage leftd = VerticalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/2/design1/border/border.bmp")));
        ...
        BufferedImage rani = ImageIO.read(new File("z-vasu/in/2/design1/pallu/pallu_rani-1.bmp"));
        BufferedImage jari = ImageIO.read(new File("z-vasu/in/2/design1/pallu/pallu_jari-1.bmp"));
