package com.varaprasadps.no4.a2024.design1.kadiyalubroc3;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/4/out/a2024/design1/3kbroc-rani-%s-%s.bmp";
        ...
        final BufferedImage jamuduFirst = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/4/in/a2024/design1/border/jamudu-first.bmp")));

        int width = left.getWidth();

        BufferedImage body = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/4/in/a2024/design1/brocade3/silver.bmp")));
