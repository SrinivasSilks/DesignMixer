...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/4/out/a2024/design1/2kbroc-nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/4/in/a2024/design1/brocade2/meena.bmp")));
