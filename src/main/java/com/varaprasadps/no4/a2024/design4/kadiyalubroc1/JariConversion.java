...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/4/out/a2024/design3/1kbroc-jari-%s-%s.bmp";

        final BufferedImage right = HorizontalRepeatGenerator.get(17, ImageIO.read(new File("d/4/in/a2024/design3/border/right.bmp")));
        final BufferedImage left = HorizontalRepeatGenerator.get(17, VerticalFlipGenerator.get(ImageIO.read(new File("d/4/in/a2024/design3/border/left.bmp"))));
