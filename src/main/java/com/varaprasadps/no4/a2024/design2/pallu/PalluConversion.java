...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BufferedImage rightt = HorizontalRepeatGenerator.get(17, ImageIO.read(new File("d/4/in/a2024/design2/border/right.bmp")));
        final BufferedImage leftt = HorizontalRepeatGenerator.get(17, VerticalFlipGenerator.get(ImageIO.read(new File("d/4/in/a2024/design2/border/left.bmp"))));
        final BufferedImage jamudut = HorizontalRepeatGenerator.get(17, ImageIO.read(new File("d/4/in/a2024/design2/border/jamudu.bmp")));
