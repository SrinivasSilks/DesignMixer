package com.varaprasadps.no4.a2024.self.design2.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage jamudu, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/4/out/a2024/design2/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage jari = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/4/in/a2024/design2/pallu/pallu_jari.bmp")));
        BufferedImage meena = PlainGenerator.get(jari.getWidth(), jari.getHeight());

        final BufferedImage rightt = HorizontalRepeatGenerator.get(8 * 1, ImageIO.read(new File("d/4/in/a2024/design2/border/right.bmp")));
        final BufferedImage leftt = HorizontalRepeatGenerator.get(8 * 1, VerticalFlipGenerator.get(ImageIO.read(new File("d/4/in/a2024/design2/border/left.bmp"))));
        final BufferedImage jamudut = HorizontalRepeatGenerator.get(8 * 1, ImageIO.read(new File("d/4/in/a2024/design2/border/jamudu.bmp")));
