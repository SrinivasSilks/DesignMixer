package com.varaprasadps.no4.a2024.self.design2.brocade2;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage jamudu, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/4/out/a2024/design2/2self-brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        final BufferedImage right = HorizontalRepeatGenerator.get(13 * 1, ImageIO.read(new File("d/4/in/a2024/design2/border/right.bmp")));
        final BufferedImage left = HorizontalRepeatGenerator.get(13 * 1, VerticalFlipGenerator.get(ImageIO.read(new File("d/4/in/a2024/design2/border/left.bmp"))));
        final BufferedImage jamudu = HorizontalRepeatGenerator.get(13 * 1, ImageIO.read(new File("d/4/in/a2024/design2/border/jamudu.bmp")));

        BufferedImage jari = HorizontalRepeatGenerator.get(12, ImageIO.read(new File("d/4/in/a2024/design2/brocade2/jari.bmp")));
