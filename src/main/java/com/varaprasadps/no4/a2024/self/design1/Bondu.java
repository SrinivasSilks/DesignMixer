package com.varaprasadps.no4.a2024.self.design1;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage blouse = ImageIO.read(new File("d/4/out/a2024/design1/kongu-1440-960.bmp"));
...
//        inputBIs.add(CutLayoutGenerator.get(konguFile, 120).get(0));
        inputBIs.add(pallu);
        inputBIs.add(CutLayoutGenerator.get(CutLayoutGenerator.get(blouse, blouse.getHeight() - (260 * 2)).get(1), 120).get(0));
