package com.varaprasadps.no4.a1recent.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/a1recent/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/4/a1recent/PALLU_RANI.bmp"));
        int width = pallu.getWidth();


        final BufferedImage border = HorizontalRepeatGenerator.get(width / 200, ImageIO.read(new File("z-data/in/4/a1recent/border.bmp")));
