...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/4/out/design2/3broc-rani-%s-%s.bmp";
        ...
        final BufferedImage body = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("d/4/in/design2/brocade3/red.bmp")));
