...
public class BodyAnniConversion {

    public static void main(final String[] args) throws IOException {

        String out = "d/4/out/body-anni-%s-%s.bmp";
        final BufferedImage right = EmptyGenerator.get(12, 480);
        final BufferedImage left =EmptyGenerator.get(12, 396);
