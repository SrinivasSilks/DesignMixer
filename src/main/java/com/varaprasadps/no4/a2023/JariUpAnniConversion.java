...
public class JariUpAnniConversion {

    public static void main(final String[] args) throws IOException {

        String out = "d/4/out/jari-up-anni-%s-%s.bmp";
        final BufferedImage right = PlainGenerator.get(12, 480);
        final BufferedImage left = PlainGenerator.get(12, 396);
