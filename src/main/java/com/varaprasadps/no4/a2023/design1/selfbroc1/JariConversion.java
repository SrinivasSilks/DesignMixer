...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/4/out/design1/1self-jari-%s-%s.bmp";

        final BufferedImage body =  HorizontalRepeatGenerator.get(18, ImageIO.read(new File("d/4/in/design1/selfbroc1/jari.bmp")));
