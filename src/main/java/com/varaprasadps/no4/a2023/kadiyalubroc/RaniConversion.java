...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/4/out/design1/kbroc-rani-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(9, ImageIO.read(new File("d/4/in/design1/border/right.bmp")));
        BufferedImage left = HorizontalRepeatGenerator.get(9, ImageIO.read(new File("d/4/in/design1/border/left-first.bmp")));
