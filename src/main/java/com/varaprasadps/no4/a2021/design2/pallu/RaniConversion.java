package com.varaprasadps.no4.a2021.design2.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/a2021/design2/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/4/a2021/design2/pallu/p-rani.bmp"));
    ...
    private static BufferedImage cut(BufferedImage read) {
        return CutLayoutGenerator.get(HorizontalRepeatGenerator.get(5, read), 2000, 0);
    }
