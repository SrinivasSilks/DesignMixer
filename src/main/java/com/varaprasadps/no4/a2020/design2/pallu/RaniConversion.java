package com.varaprasadps.no4.a2020.design2.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/a2020/design2/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/4/a2020/design2/pallu/pallu-rani.bmp"));

        final BufferedImage border = RightLayoutGenerator.get(CutLayoutGenerator.get(LeftLayoutGenerator.get(HorizontalRepeatGenerator.get(4, ImageIO.read(new File("z-data/in/4/a2020/design2/border/border.bmp")))),2000).get(0));
