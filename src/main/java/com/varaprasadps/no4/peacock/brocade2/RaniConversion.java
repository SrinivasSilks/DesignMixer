package com.varaprasadps.no4.peacock.brocade2;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/peacock/2rani-%s-%s.bmp";

        final BufferedImage rani = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/4/peacock/brocade2/RANI.bmp")));


        final BufferedImage border = HorizontalRepeatGenerator.get(14, ImageIO.read(new File("z-data/in/4/peacock/border2.bmp")));
