package com.varaprasadps.no4.peacock.anni;
...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/peacock/anni-%s-%s.bmp";
        final BufferedImage border = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-data/in/4/peacock/border2.bmp")));
