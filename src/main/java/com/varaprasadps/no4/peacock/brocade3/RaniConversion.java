...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/peacock/3rani-%s-%s.bmp";

        final BufferedImage rani = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/4/peacock/brocade3/RANI.bmp")));


        final BufferedImage border = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("z-data/in/4/peacock/border2.bmp")));
