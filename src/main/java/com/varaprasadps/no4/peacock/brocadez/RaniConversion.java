package com.varaprasadps.no4.peacock.brocadez;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/4/peacock/zrani-%s-%s.bmp";

        final BufferedImage rani = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/4/peacock/brocadez/RANI.bmp")));
