package com.varaprasadps.bala.no6;
...
public class BorderConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-bala/out/6/design1/border-%s-%s.bmp";

        final BufferedImage right = ImageIO.read(new File("z-bala/in/6/border.bmp"));
        final BufferedImage left = VerticalFlipGenerator.get(ImageIO.read(new File("z-bala/in/6/border.bmp")));
