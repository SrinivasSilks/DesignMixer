package com.varaprasadps.bala.no6.a2021.design1;
...
public class BorderConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-bala/out/6/a2021/design1/border-%s-%s.bmp";

        final BufferedImage right = ImageIO.read(new File("z-bala/in/6/a2021/design1/border.bmp"));
