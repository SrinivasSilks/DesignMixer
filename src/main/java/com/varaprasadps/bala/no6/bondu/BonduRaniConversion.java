...
public class BonduRaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BufferedImage bondu = ImageIO.read(new File("z-bala/out/6/design1/b-rani-20-1792.bmp"));
        final BufferedImage anni = ImageIO.read(new File("z-bala/out/6/design1/anni-12-1792.bmp"));
