...
public class Brocade2Conversion {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage butta = ImageIO.read(new File("z-bala/in/7/a2020/brocade/butta-space.bmp"));
        BufferedImage brocadebutta = VerticalFlipGenerator.get(get(border, butta));
        saveBMP(brocadebutta, "z-bala/out/7/a2020/brocade-butta2.bmp");
    }
    ...
    private static BufferedImage getBrocade(BufferedImage border, BufferedImage gold, int index) {
        if (border.getWidth() == 70 || border.getWidth() == 210 || (index % 2 == 0 && border.getWidth() == 280)) {
...
//        }
        ...
        for (int i = 0; i < data.size(); i++) {
            if (i < data.size() - 1) {
                ...
                saveBMP(border, "z-bala/in/7/a2020/border/border2-" + i + ".bmp");
            } else {
