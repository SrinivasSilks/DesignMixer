package com.varaprasadps.bala.no7.design2.pallu;
...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-bala/out/7/a2020/design2/p-jari-%s-%s.bmp";

        final BufferedImage body = ImageIO.read(new File("z-bala/in/7/a2020/design2/pallu/pallu-jari.bmp"));
