package com.varaprasadps.bala.no3.design2.bondu2;
...
public class BonduJariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-bala/out/3/bondu-jari-%s-%s.bmp";

        final BufferedImage bondu = ImageIO.read(new File("z-bala/out/3/design1/b-jari-20-1792.bmp"));
