package com.varaprasadps.bala.no3.design2.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-bala/out/3/design1/p-rani-%s-%s.bmp";

        final BufferedImage body = ImageIO.read(new File("z-bala/in/3/design1/pallu/pallu-rani.bmp"));
