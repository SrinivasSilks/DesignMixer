...
public class AddLayoutGenerator {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-vasu/in/3/design4/pallu/pallu_jari.bmp";

        BufferedImage image = LeftLayoutGenerator.get(ImageIO.read(new File("z-vasu/in/3/design4/pallu/pallu_jaris.bmp")));
        List<BufferedImage> inputBIs = new LinkedList<>();

        List<BufferedImage> cc = CutLayoutGenerator.get(image, 380);
        ...
        inputBIs.add(figure);
        inputBIs.add(CutLayoutGenerator.get(repeat, 12).get(1));
