...
public class CutLayoutGenerator {
    public static void main(final String[] args) throws IOException {
        String input = "z-data/in/1/a2021/design4/pallu/pallu-rani.bmp";
        BufferedImage inputBI = ImageIO.read(new File(input));

        List<BufferedImage> result = new LinkedList<>();

        List<BufferedImage> images = get(inputBI, 344);
...
//        result.add(PlainGenerator.get(a.getWidth(), 904));
        ...
        AddLayoutGenerator.saveBMP(output, "z-data/in/1/a2021/design4/pallu/p-rani.bmp");
    }
