...
public class CutLayoutGenerator {
    public static void main(final String[] args) throws IOException {
        String input = "z-data/in/3/a2021/design6/pallu/pallu-rani.bmp";
        ...
        List<BufferedImage> images2 = CutLayoutGenerator.get(images.get(1), 20);
...
//        result.add(PlainGenerator.get(a.getWidth(), 904));
        ...
        AddLayoutGenerator.saveBMP(output, "z-data/in/3/a2021/design6/pallu/p-rani.bmp");
    }
