...
public class CutLayoutGenerator {
    public static void main(final String[] args) throws IOException {
        String input = "z-data/in/12/a2021/design3/pallu/pallu-rani.bmp";
        BufferedImage inputBI = ImageIO.read(new File(input));

        List<BufferedImage> result = new LinkedList<>();

        List<BufferedImage> images = get(inputBI, 382);
        BufferedImage a = images.get(0);
        List<BufferedImage> images2 = CutLayoutGenerator.get(images.get(1), 50);
...
//        result.add(PlainGenerator.get(a.getWidth(), 904));
        ...
        AddLayoutGenerator.saveBMP(output, "z-data/in/12/a2021/design3/pallu/p-rani.bmp");
    }
