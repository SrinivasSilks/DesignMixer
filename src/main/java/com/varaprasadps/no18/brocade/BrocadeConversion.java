package com.varaprasadps.no18.brocade;
...
import static com.varaprasadps.no18.ThreePlay.*;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/18/out/design1/brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
