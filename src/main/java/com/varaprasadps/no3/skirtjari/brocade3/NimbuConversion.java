package com.varaprasadps.no3.skirtjari.brocade3;
...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/3/2-skirt/2nimbu-%s-%s.bmp";

        final BufferedImage skirt =  HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/3/2-skirt/NIMBU.bmp")));
        ...
        inputBIs.add(CutLayoutGenerator.get(skirt, 400).get(0));
        // Locking
        inputBIs.add(PlainGenerator.get(skirt.getWidth(), 20));
        inputBIs.add(CutLayoutGenerator.get(CutLayoutGenerator.get(skirt, 420).get(1), 760).get(0));
        // Locking
        inputBIs.add(PlainGenerator.get(skirt.getWidth(), 20));
