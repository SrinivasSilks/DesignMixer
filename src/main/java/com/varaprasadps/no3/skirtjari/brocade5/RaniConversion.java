package com.varaprasadps.no3.skirtjari.brocade5;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/3/5-skirt/rani-%s-%s.bmp";
        final BufferedImage skirt = HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/3/5-skirt/RANI.bmp")));
        ...
        inputBIs.add(skirt);
        // Locking
        inputBIs.add(HorizontalRepeatGenerator.get(24, ImageIO.read(new File("z-data/in/3/BORDER.bmp"))));
