...
public class ChecksConversion {

    public static void main(final String[] args) throws IOException {

        String out = "z-data/out/3/a2023new/allover-%s-%s.bmp";
        ...
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 40)));
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 68)));
        //jamudu
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 8)));
        //locking
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 8)));
        //right border PART-1
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 264)));
        //allover
        ...
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 8)));
        //right border PART-1
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 368)));
