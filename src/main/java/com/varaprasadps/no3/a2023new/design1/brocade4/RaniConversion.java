...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/3/out/design1/4brc-rani-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/design1/border/right.bmp")));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/design1/border/left-first.bmp"))));
