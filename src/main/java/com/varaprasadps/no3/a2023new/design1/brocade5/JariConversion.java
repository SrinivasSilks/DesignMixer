...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/3/out/design1/5brc-jari-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(11, ImageIO.read(new File("d/3/in/design1/border/right.bmp")));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(11, ImageIO.read(new File("d/3/in/design1/border/left.bmp"))));
