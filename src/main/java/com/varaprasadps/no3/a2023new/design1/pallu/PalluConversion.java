package com.varaprasadps.no3.a2023new.design1.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage left, BufferedImage right, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/3/out/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage jari = ImageIO.read(new File("d/3/in/design1/pallu/pallu-jari.bmp"));
        BufferedImage rani = PlainGenerator.get(jari.getWidth(), 480);

        BufferedImage rboooof = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/3/in/design1/border/right.bmp")));
        BufferedImage lboooof = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/3/in/design1/border/left.bmp"))));
