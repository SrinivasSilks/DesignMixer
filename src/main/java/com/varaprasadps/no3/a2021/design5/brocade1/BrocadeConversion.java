...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage nimbu, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, String.format("z-data/out/3/a2021/design5/brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(String[] args) throws IOException {
        BufferedImage abc = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-data/in/3/a2021/design5/border/border.bmp")));
        BufferedImage border = CutLayoutGenerator.get(CutLayoutGenerator.get(abc, 120, 1), 240, 0);
        BufferedImage jari = ImageIO.read(new File("z-data/in/3/a2021/design5/brocade/jari.bmp"));
        BufferedImage nimbu = ImageIO.read(new File("z-data/in/3/a2021/design5/brocade/nimbu.bmp"));
