...
public class BrocPlainConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-data/out/3/a2021/design4/broc-plain-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage border = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-data/in/3/a2021/design4/border/border.bmp")));
