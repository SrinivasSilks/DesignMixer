...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/3/1jari-%s-%s.bmp";
        final BufferedImage skirt = CutLayoutGenerator.get(HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/3/2/B_JARI.bmp"))),1188).get(0);
