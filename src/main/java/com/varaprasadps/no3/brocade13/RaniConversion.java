package com.varaprasadps.no3.brocade13;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/3/13rani-%s-%s.bmp";
        final BufferedImage skirt = HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/3/13/RANI.bmp")));
        ...
        inputBIs.add(skirt);
        // Locking
        inputBIs.add(HorizontalRepeatGenerator.get(60, ImageIO.read(new File("z-data/in/3/BORDER.bmp"))));
