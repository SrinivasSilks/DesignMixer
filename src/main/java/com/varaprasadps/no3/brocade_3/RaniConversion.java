package com.varaprasadps.no3.brocade_3;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BufferedImage skirt = HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/3/K_13/RANI.bmp")));
        ...
        inputBIs.add(skirt);
        // Locking
        inputBIs.add(HorizontalRepeatGenerator.get(48, ImageIO.read(new File("z-data/in/3/BORDER.bmp"))));
