...
public class Kadiyalu12Play {

    public static BufferedImage gold(BufferedImage right, BufferedImage left, BufferedImage body, BufferedImage checks) {
    ...
    public static BufferedImage jari2(BufferedImage right, BufferedImage left, BufferedImage body, BufferedImage checks) {
    ...
    public static BufferedImage rani2(BufferedImage right, BufferedImage left, BufferedImage body, BufferedImage checks) {
