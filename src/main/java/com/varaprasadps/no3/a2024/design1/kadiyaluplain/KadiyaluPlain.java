package com.varaprasadps.no3.a2024.design1.kadiyaluplain;
...
public class KadiyaluPlain {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        displayPixels(brocade);
        saveBMP(brocade, format("d/3/out/2024/design1/1kplain-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
