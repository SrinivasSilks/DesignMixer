...
import static com.varaprasadps.no3.a2024.Kadiyalu1Play.*;
import static java.lang.String.format;


public class KadiyaluGoldConversion {

//    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage checks, BufferedImage meena, BufferedImage jari) throws IOException {
//        List<BufferedImage> brocades = new LinkedList<>();
//        brocades.add(rani(right, leftback, meena, checks));
//        brocades.add(jari(right, left, meena, checks));
//        brocades.add(nimbu(getBorder(right), getBorder(left), jari, checks));
...
//    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BufferedImage jari = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/3/in/2024/design1/brocade1/jari.bmp")));
        ...
        saveBMP(brocade, format("d/3/out/2024/design1/1kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
