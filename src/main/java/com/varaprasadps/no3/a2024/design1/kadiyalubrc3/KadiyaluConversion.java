package com.varaprasadps.no3.a2024.design1.kadiyalubrc3;
...
public class KadiyaluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BufferedImage meena = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("d/3/in/2024/design1/brocade3/meena.bmp")));
