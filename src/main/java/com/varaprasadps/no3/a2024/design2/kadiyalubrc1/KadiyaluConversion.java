package com.varaprasadps.no3.a2024.design2.kadiyalubrc1;
...
public class KadiyaluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage checks = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/2024/design2/border/checks.bmp")));
        final BufferedImage meena = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/2024/design2/brocade1/meena.bmp")));
        final BufferedImage gold = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/2024/design2/brocade1/jari.bmp")));
        ...
        saveBMP(brocade, format("d/3/out/2024/design2/1kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
    }
