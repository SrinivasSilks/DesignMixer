package com.varaprasadps.no3.a2024.design2.kadiyalubrc2;
...
public class KadiyaluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage right = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/2024/design2/border/right.bmp")));
        BufferedImage leftBack = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/2024/design2/border/left-first.bmp"))));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/3/in/2024/design2/border/left.bmp"))));
        BufferedImage checks = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("d/3/in/2024/design2/border/checks.bmp")));
        final BufferedImage meena = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/3/in/2024/design2/brocade2/meena.bmp")));
        final BufferedImage gold = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/3/in/2024/design2/brocade2/gold.bmp")));
        final BufferedImage silver = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/3/in/2024/design2/brocade2/silver.bmp")));
        ...
        saveBMP(brocade, format("d/3/out/2024/design2/2kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
    }
