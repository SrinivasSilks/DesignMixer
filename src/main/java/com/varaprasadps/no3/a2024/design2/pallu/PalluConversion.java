package com.varaprasadps.no3.a2024.design2.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage left, BufferedImage right, BufferedImage rani, BufferedImage jari, BufferedImage checks) throws IOException {
        ...
        saveBMP(brocade, format("d/3/out/2024/design2/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage jari =  RightLayoutGenerator.get(HorizontalRepeatGenerator.get(1, LeftLayoutGenerator.get(ImageIO.read(new File("d/3/in/2024/design2/pallu/pallu-jari.bmp")))));
        BufferedImage rani = PlainGenerator.get(jari.getWidth(), jari.getHeight());

        BufferedImage rboooof = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/3/in/2024/design2/border/right.bmp")));
        BufferedImage lboooof = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/3/in/2024/design2/border/left.bmp"))));
