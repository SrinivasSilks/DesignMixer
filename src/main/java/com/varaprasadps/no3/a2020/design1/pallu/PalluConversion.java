package com.varaprasadps.no3.a2020.design1.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage rani, BufferedImage jari, BufferedImage chucks) throws IOException {
        ...
        saveBMP(brocade, format("z-data/out/3/a2020/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage bab = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("z-data/in/3/a2020/design1/border/border.bmp")));
