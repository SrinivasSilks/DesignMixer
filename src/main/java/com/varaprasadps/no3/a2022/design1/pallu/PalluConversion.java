package com.varaprasadps.no3.a2022.design1.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage border, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-data/out/3/a2022/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage boooof = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("z-data/in/3/a2022/design1/border/border.bmp")));
        BufferedImage border = CutLayoutGenerator.get(boooof, 180, 1);
        BufferedImage jari = ImageIO.read(new File("z-data/in/3/a2022/design1/pallu/pallu-jari.bmp"));
