...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/3rani-%s-%s.bmp";
        ...
        BufferedImage figure = HorizontalRepeatGenerator.get(1,HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/8/test/figure.bmp"))));
