...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/3nimbu-%s-%s.bmp";

        final BufferedImage body = HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/8/test/nimbu.bmp")));
        final BufferedImage skirt = CutLayoutGenerator.get(HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/8/brocade2/NIMBU.bmp"))), 1480).get(0);
