package com.varaprasadps.no8.a2023.design1;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/8/a2023/design1/pset.bmp";

        BufferedImage anni = ImageIO.read(new File("z-data/out/8/a2023/design1/anni-240-1824.bmp"));
        BufferedImage kongu = ImageIO.read(new File("z-data/out/8/a2023/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/8/a2023/design1/kanni-1824-480.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/8/a2023/design1/pallu-1824-3412.bmp"));
