...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage rightt = HorizontalRepeatGenerator.get(16, ImageIO.read(new File("z-data/in/8/a2023/design3/border/right.bmp")));
        BufferedImage leftt = HorizontalRepeatGenerator.get(16, ImageIO.read(new File("z-data/in/8/a2023/design3/border/left.bmp")));
