...
public class KadiyaluBrocade {

    public static BufferedImage merge(
            BufferedImage leftFirst,
            BufferedImage left,
            BufferedImage right,
            BufferedImage nimbu,
            BufferedImage jari
        ...
        inputs.add(rani(leftFirst, right, nimbu));
        inputs.add(jari(left, right, nimbu));
        inputs.add(nimbu(left, right, jari));
        return LeftLayoutGenerator.get(ColumnRepeatGenerator.get(inputs));
    }

    private static BufferedImage nimbu(BufferedImage left, BufferedImage right, BufferedImage body) {
    ...
    private static BufferedImage jari(BufferedImage left, BufferedImage right, BufferedImage body) {
    ...
    private static BufferedImage rani(BufferedImage left, BufferedImage right, BufferedImage body) {
        int width = left.getWidth();
