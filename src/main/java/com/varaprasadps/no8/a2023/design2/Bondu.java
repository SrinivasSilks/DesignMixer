...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/8/a2023/design2/pset.bmp";

        BufferedImage anni = ImageIO.read(new File("z-data/out/8/a2023/design2/anni-300-1824.bmp"));
        BufferedImage kongu = ImageIO.read(new File("z-data/out/8/a2023/design2/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/8/a2023/design2/kanni-1824-600.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/8/a2023/design2/pallu-1824-3412.bmp"));
...
//        inputBIs.add(brocade);
        ...
        inputBIs.add(pallu);
        inputBIs.add(CutLayoutGenerator.get(CutLayoutGenerator.get(anni, 140).get(1), 80).get(1));
