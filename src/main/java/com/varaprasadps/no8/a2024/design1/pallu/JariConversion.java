...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/8/out/2024/design1/p-jari-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/8/in/2024/design1/pallu/pallu-jari.bmp")));
