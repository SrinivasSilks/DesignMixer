package com.varaprasadps.no8.a2024.design1;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "d/8/out/2024/design1/pset.bmp";

        BufferedImage anni = ImageIO.read(new File("d/8/out/2024/design1/anni-300-1824.bmp"));
        BufferedImage kongu = ImageIO.read(new File("d/8/out/2024/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("d/8/out/2024/design1/kanni-1824-600.bmp"));
        BufferedImage pallu = ImageIO.read(new File("d/8/out/2024/design1/pallu-1824-3412.bmp"));
...
//        inputBIs.add(brocade);
        ...
        inputBIs.add(pallu);
        inputBIs.add(CutLayoutGenerator.get(CutLayoutGenerator.get(anni, 176).get(1), 60).get(1));
