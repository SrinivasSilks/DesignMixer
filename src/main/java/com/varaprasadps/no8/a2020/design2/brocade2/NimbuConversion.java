...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2020/8design2/2nimbu-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(11, ImageIO.read(new File("z-data/in/8/a2020/8design2/brocade2/jari.bmp")));
