package com.varaprasadps.no8.a2020.design2.brocade3;
...
public class AddLayoutButtaConversion {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage bbbb = LeftLayoutGenerator.get(cut(HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/8/a2020/8design2/brocade3/single-goldjari.bmp"))), 1320));
        BufferedImage cccc = LeftLayoutGenerator.get(cut(HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/8/a2020/8design2/brocade3/nimbu.bmp"))), 1320));
        ...
        BufferedImage eeee = LeftLayoutGenerator.get(cut(HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/8/a2020/8design2/brocade3/single-whitejari.bmp"))), 1320));
        ...
        saveBMP(eeee, "z-data/in/8/a2020/8design2/test2/eeee.bmp");
        ...
        for (int i = 0; i < data.size(); i++) {
            if (i < data.size() - 1) {
                ...
                saveBMP(white, String.format("z-data/in/8/a2020/8design2/test2/white-%s.bmp", i));
        ...
        for (BufferedImage input : result) {
            saveBMP(input, String.format("z-data/out/8/a2020/8design2/test2/test-brocade3-%s.bmp", i++));
        }
        BufferedImage bufferedImage = AddLayoutGenerator.get(result);
        saveBMP(bufferedImage, "z-data/out/8/a2020/8design2/brocade3.bmp");
    }
    ...
    private static BufferedImage getBrocade(BufferedImage border, BufferedImage gold, BufferedImage nimbu,
        ...
        if (border.getWidth() == 18) {
            return WhiteJariBrocade.get(border, white, nimbu, chuck);
        }
        return null;
    }
