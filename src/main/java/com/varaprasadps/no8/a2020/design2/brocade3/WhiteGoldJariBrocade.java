...
public class WhiteGoldJariBrocade {
    ...
    public static BufferedImage get(BufferedImage border,
                                    ...
                                    BufferedImage white,
                                    BufferedImage nimbu,
                                    BufferedImage chucks) throws IOException {
        List<BufferedImage> brocades = new LinkedList<>();
        brocades.add(rani(border, empty(border.getWidth())));
        brocades.add(jari(getBorder(border), nimbu, chucks));
        brocades.add(nimbu(getBorder(border), white, chucks));
        brocades.add(extra(getBorder(border), gold, chucks));
        BufferedImage brocade = LeftLayoutGenerator.get(getBrocade(brocades));
        saveBMP(brocade, String.format("z-data/out/8/a2020/8design2/test2/wg-%s-brocade.bmp", i++));
        return brocade;
    }
    ...
    private static BufferedImage extra(BufferedImage border, BufferedImage jari, BufferedImage chucks) {
