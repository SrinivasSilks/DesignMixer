package com.varaprasadps.no8.a2020.design2.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2020/8design2/p-rani-%s-%s.bmp";

        BufferedImage test = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("z-data/in/8/a2020/8design2/border/border.bmp")));
        ...
        final BufferedImage pallu = ImageIO.read(new File("z-data/in/8/a2020/8design2/pallu/pallu-rani.bmp"));
