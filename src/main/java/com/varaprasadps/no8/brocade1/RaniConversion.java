...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/1rani-%s-%s.bmp";
        ...
        final BufferedImage skirt = CutLayoutGenerator.get(HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/8/brocade1/RANI.bmp"))), 1480).get(0);
