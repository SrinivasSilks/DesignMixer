package com.varaprasadps.no8.a2020oct.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2020oct/design1/p-rani-%s-%s.bmp";

        BufferedImage test = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("z-data/in/8/a2020oct/design1/border.bmp")));
