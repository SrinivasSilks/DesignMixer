package com.varaprasadps.no8.a2021.design3.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2021/design3/p-rani-%s-%s.bmp";

        BufferedImage test = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/8/a2021/design3/border/border.bmp")));
