...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2021/design2/1jari-%s-%s.bmp";

        BufferedImage brocade = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-data/in/8/a2021/design2/brocade/nimbu.bmp")));
