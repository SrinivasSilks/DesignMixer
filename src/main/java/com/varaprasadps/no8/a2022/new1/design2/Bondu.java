package com.varaprasadps.no8.a2022.new1.design2;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/8/a2022/own/design2/bondu.bmp";

        BufferedImage anni = ImageIO.read(new File("z-data/out/8/a2022/own/design2/anni-120-1824.bmp"));
        BufferedImage kongu = ImageIO.read(new File("z-data/out/8/a2022/own/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/8/a2022/own/design2/kanni-1824-240.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/8/a2022/own/design2/pallu-1824-3412.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/8/a2022/own/design2/kadiyalu/kadiyalu-broc-1824-2520.bmp"));
...
//        inputBIs.add(brocade);
        ...
        inputBIs.add(pallu);
        inputBIs.add(CutLayoutGenerator.get(anni, 86).get(1));
