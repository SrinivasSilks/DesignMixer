...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2022/design1/1jari-%s-%s.bmp";

        BufferedImage brocade = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-data/in/8/a2022/design1/brocade2/nimbu.bmp")));
