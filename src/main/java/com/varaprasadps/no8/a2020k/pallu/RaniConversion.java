package com.varaprasadps.no8.a2020k.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2020k/design1/p-rani-%s-%s.bmp";

        BufferedImage test = HorizontalRepeatGenerator.get(9, ImageIO.read(new File("z-data/in/8/a2020k/border/border.bmp")));
