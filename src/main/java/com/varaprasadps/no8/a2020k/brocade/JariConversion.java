...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2020k/design1/1jari-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("z-data/in/8/a2020k/brocade/nimbu.bmp")));
