package com.varaprasadps.no8.a2020k.brocade;
...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/8/a2020k/design1/1nimbu-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("z-data/in/8/a2020k/brocade/butta.bmp")));
        final BufferedImage chucks = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("z-data/in/8/a2020k/brocade/chucks.bmp")));
