...
public class JariUpConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/9/out/design1/jari-up-%s-%s.bmp";

        BufferedImage right = ReverseGenerator.get(EmptyGenerator.get(2, 480));
        BufferedImage left = ReverseGenerator.get(EmptyGenerator.get(2, 288));

        BufferedImage body =  EmptyGenerator.get(right.getWidth(), 960);
