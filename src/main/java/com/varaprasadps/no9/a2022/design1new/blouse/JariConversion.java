...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/9/a2022/design1new/b-jari-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(18, ImageIO.read(new File("z-data/in/9/a2022/design1new/blouse/rani.bmp")));
