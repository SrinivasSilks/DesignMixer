...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/5/out/2024/design3/1kbroc-nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("d/5/in/2024/design3/brocade1/gold.bmp")));
