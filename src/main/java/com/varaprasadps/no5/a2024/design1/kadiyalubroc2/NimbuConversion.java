...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/5/out/2024/design1/2kbroc-nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("d/5/in/2024/design1/brocade2/meena.bmp")));
