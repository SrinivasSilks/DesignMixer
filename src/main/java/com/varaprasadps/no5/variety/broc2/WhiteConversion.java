...
public class WhiteConversion {

    public static void main(final String[] args) throws IOException {

        String out = "z-data/out/5/variety/b2-white-%s-%s.bmp";
        final BufferedImage subject = ImageIO.read(new File("z-data/in/5/variety/processed/WHITE-2.bmp"));
