package com.varaprasadps.no5.a2021b.design2.pallu;
...
public class  RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BufferedImage rightt = ImageIO.read(new File("z-data/in/5/a2021b/design2/border/right.bmp"));
        final BufferedImage leftt = ImageIO.read(new File("z-data/in/5/a2021b/design2/border/left.bmp"));
        ...
        final BufferedImage pallu = ImageIO.read(new File("z-data/in/5/a2021b/design2/pallu/pallu-rani.bmp"));
