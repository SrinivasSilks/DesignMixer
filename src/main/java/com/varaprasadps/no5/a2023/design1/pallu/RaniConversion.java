...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/5/out/design1/p-rani-%s-%s.bmp";

        final BufferedImage rightt = HorizontalRepeatGenerator.get(6, ImageIO.read(new File("d/5/in/design1/border/right.bmp")));
        final BufferedImage leftt = HorizontalRepeatGenerator.get(6, VerticalFlipGenerator.get(ImageIO.read(new File("d/5/in/design1/border/left.bmp"))));
