...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2021/design4/2rani-%s-%s.bmp";
        ...
        final BufferedImage right = HorizontalRepeatGenerator.get(6, imageRightt);
        final BufferedImage left = HorizontalRepeatGenerator.get(6, imageLeftt);
        final BufferedImage rani = ImageIO.read(new File("z-data/in/5/a2021/design4/brocade2/rani.bmp"));
