...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2021/design4/1nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/5/a2021/design4/brocade/jari.bmp")));
