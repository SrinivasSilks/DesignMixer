package com.varaprasadps.no5.a2021.design1;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/5/a2021/design1/set.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-data/out/5/a2021/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/5/a2021/design1/kanni-1824-720.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-data/out/5/a2021/design1/anni-360-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/5/a2021/design1/pallu-1824-3960.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/5/a2021/design1/1brocade-1824-5400.bmp"));
