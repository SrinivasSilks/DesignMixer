package com.varaprasadps.no5.a2021.design3;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/5/a2021/design3/pset.bmp";

        BufferedImage anni = ImageIO.read(new File("z-data/out/5/a2021/design3/anni-240-1824.bmp"));
        BufferedImage kongu = ImageIO.read(new File("z-data/out/5/a2021/design2/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/5/a2021/design3/kanni-1824-480.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/5/a2021/design3/pallu-1824-3960.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/5/a2021/design3/1brocade-1824-3600.bmp"));
