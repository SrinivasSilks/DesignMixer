...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2021/design3/1nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(6, ImageIO.read(new File("z-data/in/5/a2021/design3/brocade2/jari.bmp")));
