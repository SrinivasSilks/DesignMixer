package com.varaprasadps.no5.a2021.design3.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2021/design3/p-rani-%s-%s.bmp";

        final BufferedImage rightt = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/5/a2021/design3/border1/right.bmp")));
        final BufferedImage leftt = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/5/a2021/design3/border1/left.bmp")));
