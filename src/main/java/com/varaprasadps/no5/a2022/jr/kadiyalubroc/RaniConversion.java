...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2022/jr/kbroc-rani-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("z-data/in/5/a2022/jr/border/right.bmp")));
        BufferedImage left = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("z-data/in/5/a2022/jr/border/left1-first.bmp")));
