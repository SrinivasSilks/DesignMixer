...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/jr/design1/1rani-%s-%s.bmp";
        ...
        final BufferedImage right = HorizontalRepeatGenerator.get(3, chop(imageRightt, 160));
        final BufferedImage left = HorizontalRepeatGenerator.get(3, chop(imageLeftt, 160));
