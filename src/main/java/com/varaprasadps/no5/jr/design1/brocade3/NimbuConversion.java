...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/jr/design1/3nimbu-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(20, ImageIO.read(new File("z-data/in/5/jr/design1/brocade3/jari.bmp")));
