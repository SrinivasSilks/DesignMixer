package com.varaprasadps.no5.a2021k.design1.brocade;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2021k/design1/b-rani-%s-%s.bmp";
        ...
        final BufferedImage pallu = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/5/a2021k/rani.bmp")));
