...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/5/a2020/design3/broc-rani-%s-%s.bmp";

        BufferedImage border = ReverseGenerator.get(ImageIO.read(new File("z-data/in/5/a2020/design3/border/border-meena.bmp")));
        ...
        inputBIs.add(PlainGenerator.get(width, 260));
        inputBIs.add(border);
