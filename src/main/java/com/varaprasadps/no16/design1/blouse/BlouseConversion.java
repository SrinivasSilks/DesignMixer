package com.varaprasadps.no16.design1.blouse;
...
public class BlouseConversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/16/out/design1/blouse-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage rani = blouse(ImageIO.read(new File("d/16/in/design1/blouse/jari.bmp")));
        BufferedImage jari = blouse(ImageIO.read(new File("d/16/in/design1/blouse/rani.bmp")));
    ...
    private static BufferedImage blouse(BufferedImage image) {
        return HorizontalRepeatGenerator.get(30, VerticalRepeatGenerator.get(2, image));
    }
