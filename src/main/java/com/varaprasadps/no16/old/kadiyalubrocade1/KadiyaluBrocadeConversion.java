...
public class KadiyaluBrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        BufferedImage rightJari = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/16/in/design1/border/right.bmp")));
        BufferedImage teegaJari = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/16/in/design1/border/teega.bmp")));
        BufferedImage banarasJari = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/16/in/design1/border/repeat.bmp")));
        ...
        BufferedImage nimbu = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("d/16/in/design1/brocade1/nimbu.bmp")));
        BufferedImage jari = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("d/16/in/design1/brocade1/jari.bmp")));
