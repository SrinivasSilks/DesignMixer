package com.varaprasadps.no16.design2.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/16/out/design2/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage jari = CutLayoutGenerator.get(ImageIO.read(new File("d/16/in/design2/pallu/pallu-jari.bmp")), 480).get(0);
        BufferedImage anni = CutLayoutGenerator.get(ImageIO.read(new File("d/16/in/design2/pallu/pallu-rani.bmp")), 480).get(0);
        int width = jari.getWidth();

        BufferedImage right = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("d/16/in/design2/border/right.bmp")));
        BufferedImage teega = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("d/16/in/design2/border/teega.bmp")));
        BufferedImage figure = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("d/16/in/design2/border/repeat.bmp")));
