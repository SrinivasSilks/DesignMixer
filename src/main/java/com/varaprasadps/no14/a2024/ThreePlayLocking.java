...
public class ThreePlayLocking {
    ...
    public static BufferedImage nimbu(BufferedImage right, BufferedImage left, BufferedImage bodyResham, BufferedImage bodyJari) {
        ...
        inputBIs.add(CutLayoutGenerator.get(left, left.getHeight() - 8).get(0));
        ...
        inputBIs.add(PlainGenerator.get(width, 8));
        inputBIs.add(PlainGenerator.get(width, 8));
        inputBIs.add(CutLayoutGenerator.get(right, 8).get(1));
        //jamudu
        inputBIs.add(EmptyGenerator.get(width, 24));
    ...
    public static BufferedImage jari(BufferedImage right, BufferedImage left, BufferedImage bodyResham, BufferedImage bodyJari) {
    ...
    public static BufferedImage rani(BufferedImage right, BufferedImage left, BufferedImage bodyResham, BufferedImage bodyJari) {
