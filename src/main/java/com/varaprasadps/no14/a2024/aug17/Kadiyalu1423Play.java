...
public class Kadiyalu1423Play {

    public static BufferedImage orange(BufferedImage right, BufferedImage left, BufferedImage bodyResham, BufferedImage bodyJari) {
    ...
    public static BufferedImage green(BufferedImage right, BufferedImage left, BufferedImage bodyResham, BufferedImage bodyJari) {
        ...
        inputBIs.add(ReverseGenerator.get(left));
        //locking
        inputBIs.add(EmptyGenerator.get(width, 4));
        inputBIs.add(StepLayoutGenerator.get(width, 1));
        //body
        ...
        inputBIs.add(StepLayoutGenerator.get(width, 1));
        inputBIs.add(EmptyGenerator.get(width, 4));
        inputBIs.add(ReverseGenerator.get(right));
