...
public class KadiyaluBrocade2JAriConversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/14/out/2024/aug17/2kadiyalu-broc-jari-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage bodyReshamJ = repeat(ReverseGenerator.get(ImageIO.read(new File("d/14/in/2024/aug17/brocade2/silver-silk.bmp"))));
        BufferedImage bodyJariJ = repeat(ReverseGenerator.get(ImageIO.read(new File("d/14/in/2024/aug17/brocade2/silver-jari.bmp"))));

        BufferedImage bodyReshamR = repeat(ReverseGenerator.get(ImageIO.read(new File("d/14/in/2024/aug17/brocade2/rani-silk.bmp"))));
        BufferedImage bodyJariR = repeat(ReverseGenerator.get(ImageIO.read(new File("d/14/in/2024/aug17/brocade2/rani-jari.bmp"))));
