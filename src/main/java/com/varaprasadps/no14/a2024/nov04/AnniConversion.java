...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/14/out/2024/nov04/anni-%s-%s.bmp";

        BufferedImage left = VerticalFlipGenerator.get(ImageIO.read(new File("d/14/in/2024/nov04/border/left.bmp")));
        BufferedImage right = ImageIO.read(new File("d/14/in/2024/nov04/border/right.bmp"));
