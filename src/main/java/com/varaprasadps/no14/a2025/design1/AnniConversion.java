...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "d/14/out/2025/design1/anni-%s-%s.bmp";

        BufferedImage left = HorizontalRepeatGenerator.get(11, VerticalFlipGenerator.get(ImageIO.read(new File("d/14/in/2025/design1/border/left.bmp"))));
        BufferedImage right = HorizontalRepeatGenerator.get(11, ImageIO.read(new File("d/14/in/2025/design1/border/right.bmp")));
