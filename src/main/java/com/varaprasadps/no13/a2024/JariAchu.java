...
public class JariAchu {

    public static void main(final String[] args) throws IOException {

        String out = "d/13/out/2024/design1/jari-achu-%s-%s.bmp";

        BufferedImage rightJari = PlainGenerator.get(20, 592);
        BufferedImage rightMeena = EmptyGenerator.get(20, 592);
        BufferedImage leftFigureJari = PlainGenerator.get(20, 64);
        BufferedImage leftFigureMeena = EmptyGenerator.get(20, 64);
        BufferedImage leftTeegaJari = PlainGenerator.get(20, 48);
