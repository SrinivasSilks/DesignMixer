...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage rightJari, BufferedImage leftFigureJari, BufferedImage leftTeegaJari, BufferedImage anni, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/13/out/2024/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage jari = ImageIO.read(new File("d/13/in/2024/design1/pallu/pallu-jari.bmp"));
        BufferedImage anni = ImageIO.read(new File("d/13/in/2024/design1/pallu/pallu-rani.bmp"));
        int width = jari.getWidth();

        BufferedImage right = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("d/13/in/2024/design1/border/right.bmp")));
        BufferedImage teega = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("d/13/in/2024/design1/border/teega.bmp")));
        BufferedImage figure = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("d/13/in/2024/design1/border/banaras.bmp")));
