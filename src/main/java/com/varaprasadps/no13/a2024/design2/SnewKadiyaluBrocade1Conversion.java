...
import static com.varaprasadps.no13.a2024.S222Kadiyalu3Play.*;
import static java.lang.String.format;


public class SnewKadiyaluBrocade1Conversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/13/out/2024/design2/3kadiyalu-broc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
...
//        return VerticalRepeatGenerator.get(1, ReverseGenerator.get(HorizontalRepeatGenerator.get(5, image)));
    ...
    public static BufferedImage borderWithLocking(BufferedImage input) {
        ...
        BufferedImage border = AddLayoutGenerator.get(result);
