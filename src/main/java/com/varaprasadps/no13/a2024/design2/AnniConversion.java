...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/13/out/2024/design2/anni-%s-%s.bmp";

        BufferedImage rightJari = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/13/in/2024/design2/border/right.bmp")));
        BufferedImage teega = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/13/in/2024/design2/border/teega.bmp")));
        BufferedImage figure = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/13/in/2024/design2/border/repeat.bmp")));
