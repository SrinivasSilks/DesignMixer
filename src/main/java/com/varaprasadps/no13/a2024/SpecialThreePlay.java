...
public class SpecialThreePlay {

    public static BufferedImage nimbu(BufferedImage rightMeena, BufferedImage rightJari, BufferedImage body) {
    ...
    public static BufferedImage jari(BufferedImage rightMeena, BufferedImage rightJari,  BufferedImage body) {
    ...
    public static BufferedImage rani(BufferedImage rightMeena, BufferedImage rightJari, BufferedImage leftFigureJari, BufferedImage leftTeegaJari, BufferedImage body) {
