...
public class JariDown {

    public static void main(final String[] args) throws IOException {

        String out = "d/13/out/2024/design1/jari-down-%s-%s.bmp";

        BufferedImage rightJari = EmptyGenerator.get(20, 592);
        BufferedImage rightMeena = BlackGenerator.get(20, 592);
        BufferedImage leftFigureJari = EmptyGenerator.get(20, 64);
        BufferedImage leftFigureMeena = BlackGenerator.get(20, 64);
        BufferedImage leftTeegaJari = EmptyGenerator.get(20, 48);
        BufferedImage leftTeegaMeena = BlackGenerator.get(20, 48);
