...
public class Kadiyalu3Play {
    ...
    public static BufferedImage silver(BufferedImage rightSilk, BufferedImage rightJari, BufferedImage leftBanarasSilk, BufferedImage leftBanarasJari, BufferedImage leftTeegaSilk, BufferedImage leftTeegaJari, BufferedImage body) {
        ...
        //left Figure
        inputBIs.add(VerticalFlipGenerator.get(leftBanarasJari));
        inputBIs.add(VerticalFlipGenerator.get(leftBanarasSilk));
        //left Teega
        inputBIs.add(VerticalFlipGenerator.get(leftTeegaJari));
        inputBIs.add(VerticalFlipGenerator.get(leftTeegaSilk));
    ...
    public static BufferedImage green(BufferedImage rightMeena, BufferedImage rightJari, BufferedImage leftFigureMeena, BufferedImage leftFigureJari, BufferedImage leftTeegaMeena, BufferedImage leftTeegaJari, BufferedImage body) {
    ...
    public static BufferedImage laveTwo(BufferedImage rightMeena, BufferedImage rightJari, BufferedImage leftFigureMeena, BufferedImage leftFigureJari, BufferedImage leftTeegaMeena, BufferedImage leftTeegaJari, BufferedImage body) {
    ...
    public static BufferedImage laveOne(BufferedImage rightMeena, BufferedImage rightJari, BufferedImage leftFigureMeena, BufferedImage leftFigureJari, BufferedImage leftTeegaMeena, BufferedImage leftTeegaJari, BufferedImage body) {
