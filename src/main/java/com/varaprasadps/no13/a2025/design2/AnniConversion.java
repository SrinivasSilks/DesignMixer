...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/13/out/2025/design2/anni-%s-%s.bmp";

        BufferedImage rightJari = border(HorizontalRepeatGenerator.get(6, ImageIO.read(new File("d/13/in/2025/design2/border-normal/jari.bmp"))));
