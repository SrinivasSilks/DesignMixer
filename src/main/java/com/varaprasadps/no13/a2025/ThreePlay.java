...
public class ThreePlay {
    ...
    public static BufferedImage nimbu( BufferedImage rightSilk, BufferedImage rightJari,
                                       BufferedImage leftBanarasSilk, BufferedImage leftBanarasJari,
                                       BufferedImage leftTeegaSilk, BufferedImage leftTeegaJari,
                                       BufferedImage body) {
        ...
        //left Figure
        inputBIs.add(leftBanarasJari);
        inputBIs.add(leftBanarasSilk);
        //left Teega
        inputBIs.add(leftTeegaJari);
        inputBIs.add(leftTeegaSilk);
    ...
    public static BufferedImage jari(BufferedImage rightSilk, BufferedImage rightJari,
                                     BufferedImage leftBanarasSilk, BufferedImage leftBanarasJari,
                                     BufferedImage leftTeegaSilk, BufferedImage leftTeegaJari,
                                     BufferedImage body) {
    ...
    public static BufferedImage rani(BufferedImage rightSilk, BufferedImage rightJari,
                                     BufferedImage leftBanarasSilk, BufferedImage leftBanarasJari,
                                     BufferedImage leftTeegaSilk, BufferedImage leftTeegaJari,
                                     BufferedImage body) {

        int width = leftBanarasSilk.getWidth();
