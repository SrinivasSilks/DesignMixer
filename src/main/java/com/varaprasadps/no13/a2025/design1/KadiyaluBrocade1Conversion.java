...
public class KadiyaluBrocade1Conversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/13/out/2025/design1/1kadiyalu-broc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage jari = bodyRepeat(ImageIO.read(new File("d/13/in/2025/design1/brocade1/silver.bmp")));
        BufferedImage meena = bodyRepeat(ImageIO.read(new File("d/13/in/2025/design1/brocade1/meena.bmp")));
    ...
    public static BufferedImage border(BufferedImage image) {
        return VerticalRepeatGenerator.get(1, HorizontalRepeatGenerator.get(3, image));
    }
