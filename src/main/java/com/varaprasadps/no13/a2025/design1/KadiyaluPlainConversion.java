...
public class KadiyaluPlainConversion {
    ...
    public static BufferedImage get(
        ...
        saveBMP(brocade, format("d/13/out/2025/design1/1kadiyalu-plain-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage jari = bodyRepeat(PlainGenerator.get(figureJari.getWidth(), 480));

        get(rightMeena, rightJari, teegaMeena, teegaJari, figureMeena, figureJari, jari);
    }
