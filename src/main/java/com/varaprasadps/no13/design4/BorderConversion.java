package com.varaprasadps.no13.design4;
...
public class BorderConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/13/design4/4BORDER.bmp";

        final BufferedImage border = ImageIO.read(new File("z-data/in/13/design4/border/border.bmp"));
