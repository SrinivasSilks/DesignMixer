...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/7/out/2024/design1/2broc-jari-%s-%s.bmp";

        BufferedImage pallu = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("d/7/in/2024/design1/brocade2/silver.bmp")));
