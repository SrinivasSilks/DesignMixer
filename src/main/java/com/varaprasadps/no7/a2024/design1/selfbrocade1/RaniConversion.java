...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/7/out/2024/design1/1broc-rani-%s-%s.bmp";
        ...
        BufferedImage meena = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("d/7/in/2024/design1/brocade1/meena.bmp")));
