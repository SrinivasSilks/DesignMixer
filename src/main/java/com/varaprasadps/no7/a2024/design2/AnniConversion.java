...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/7/out/2024/design2/anni-%s-%s.bmp";

        BufferedImage left = ImageIO.read(new File("d/7/in/2024/design2/border/left.bmp"));
        BufferedImage right = ImageIO.read(new File("d/7/in/2024/design2/border/right.bmp"));
