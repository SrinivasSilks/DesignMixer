...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/7/out//design1/10kbroc-nimbu-%s-%s.bmp";
        ...
        BufferedImage body = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("d/7/in/design1/brocade10/meena.bmp")));
