...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/7/a2023/design1/pallu-jari-%s-%s.bmp";

        BufferedImage pallu = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-data/in/7/a2023/design1/pallu/pallu-jari.bmp")));
