...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a1recent/1jari-%s-%s.bmp";
        final BufferedImage body = HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/6/a1recent/1/NIMBU.bmp")));
