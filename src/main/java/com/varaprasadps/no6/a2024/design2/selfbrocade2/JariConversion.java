...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/6/out/design2/2b-jari-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(19, ImageIO.read(new File("d/6/in/design2/brocade2/jari.bmp")));
