...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2020/temp/1jari-%s-%s.bmp";
        final BufferedImage body =  HorizontalRepeatGenerator.get(9, ImageIO.read(new File("z-data/in/6/6-temp/57.bmp")));
