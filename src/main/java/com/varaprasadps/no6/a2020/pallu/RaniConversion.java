package com.varaprasadps.no6.a2020.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2020/design1/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/6/design1/pallu/PALLU_RANI.bmp"));
        final BufferedImage border = ImageIO.read(new File("z-data/in/6/design1/pallu/pallu-border.bmp"));
        final BufferedImage left = ImageIO.read(new File("z-data/in/6/design1/pallu/pallu-left-border.bmp"));
