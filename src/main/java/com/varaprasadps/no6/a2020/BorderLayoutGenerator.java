...
public class BorderLayoutGenerator {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/in/6/design1/border1/border.bmp";
        ...
        inputBIs.add(PlainGenerator.get(200, 3));
        inputBIs.add(bugada);
        inputBIs.add(chucks);
        inputBIs.add(round);
        ...
        inputBIs.add(round);
        inputBIs.add(rChucks);
        inputBIs.add(halfRound);
        inputBIs.add(chucks);
        inputBIs.add(round);
        inputBIs.add(rChucks);

        inputBIs.add(ReverseGenerator.get(StepLayoutGenerator.get(200, 80, 5)));
