package com.varaprasadps.no6.brocade_7;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/7rani-%s-%s.bmp";
        final BufferedImage skirt = ImageIO.read(new File("z-data/in/6/7/RANI.bmp"));
        ...
        // Jari
        inputBIs.add(HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/6/2/SUNUNDA.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/6/2/BANARAS.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/6/2/TEEGA.bmp"))));
