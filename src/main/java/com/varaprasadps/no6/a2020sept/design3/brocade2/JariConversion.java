...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2020sept/design3/1jari-%s-%s.bmp";

        final BufferedImage border = HorizontalRepeatGenerator.get(3, ReverseGenerator.get(ImageIO.read(new File("z-data/in/6/a2020sept/design3/border/border-jari.bmp"))));
        BufferedImage raw = VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/6/a2020sept/design3/brocade/jari.bmp")));
