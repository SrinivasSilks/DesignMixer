...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2020sept/design3/p-jari-%s-%s.bmp";


        BufferedImage v = HorizontalRepeatGenerator.get(8, ReverseGenerator.get(ImageIO.read(new File("z-data/in/6/a2020sept/design3/border/border-jari.bmp"))));
