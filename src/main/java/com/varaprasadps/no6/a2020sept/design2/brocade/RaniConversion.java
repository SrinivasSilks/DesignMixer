...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2020sept/design2/rani-%s-%s.bmp";

        final BufferedImage border = ReverseGenerator.get(ImageIO.read(new File("z-data/in/6/a2020sept/design2/border/border-meena.bmp")));
        BufferedImage raw = VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/6/a2020sept/design2/brocade/rani.bmp")));
