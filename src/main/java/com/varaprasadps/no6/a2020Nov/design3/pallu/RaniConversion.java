...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2021/design1/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/6/a2020nov/design1/pallu/pallu-rani.bmp"));
        BufferedImage meenainput = HorizontalRepeatGenerator.get(20, ImageIO.read(new File("z-data/in/6/a2021/design1/border/rani/meena.bmp")));
        BufferedImage jariinput = HorizontalRepeatGenerator.get(20, ImageIO.read(new File("z-data/in/6/a2021/design1/border/rani/jari.bmp")));
