package com.varaprasadps.no6.a2020Nov;
...
public class JariUpTwoConversion {


    public static void main(final String[] args) throws IOException {

        String out = "z-data/out/6/a2020nov/jariup2-%s-%s.bmp";
        ...
        //jari
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 400)));
        //allover
