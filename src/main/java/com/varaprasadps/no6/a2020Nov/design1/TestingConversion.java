package com.varaprasadps.no6.a2020Nov.design1;
...
public class TestingConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/a2020nov/design1/testing-%s-%s.bmp";

        BufferedImage meena = EmptyGenerator.get(100, 400);
        BufferedImage jari = PlainGenerator.get(100, 400);
