...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/6/8_1rani-%s-%s.bmp";
        final BufferedImage skirt = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/6/8.1/RANI.bmp")));
        ...
        // Jari
        inputBIs.add(HorizontalRepeatGenerator.get(28, ImageIO.read(new File("z-data/in/6/2/SUNUNDA.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(28, ImageIO.read(new File("z-data/in/6/2/BANARAS.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(28, ImageIO.read(new File("z-data/in/6/2/TEEGA.bmp"))));
