...
public class KadiyaluPlainConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/2/out/design2/1kadiyalu-plain-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("d/2/out/design2/1kpln-rani-240-2688.bmp");
        inputs.add("d/2/out/design2/1kpln-jari-240-2688.bmp");
