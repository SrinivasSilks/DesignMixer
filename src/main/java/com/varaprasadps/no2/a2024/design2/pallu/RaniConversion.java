package com.varaprasadps.no2.a2024.design2.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/2/out/design2/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("d/2/in/design2/pallu/pallu-rani.bmp"));
        int width = pallu.getWidth();

        BufferedImage leftt = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/2/in/design2/border/left.bmp")));
        BufferedImage left = CutLayoutGenerator.get(CutLayoutGenerator.get(leftt, 180, 1), pallu.getWidth(), 0);

        BufferedImage rightt = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/2/in/design2/border/right.bmp")));
