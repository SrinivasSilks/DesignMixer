...
public class KadiyaluAnniPlay {
    ...
    public static BufferedImage jari(BufferedImage right, BufferedImage left, BufferedImage body) {
        ...
        BufferedImage bufferedImage = AddLayoutGenerator.get(repeatWidth, repeatHeight, inputBIs);
        displayPixelsssss(bufferedImage);
    ...
    public static void displayPixelsssss(BufferedImage fileOne) {
        System.out.println(String.format("Brocade ======> Width : %s, Height : %s", fileOne.getWidth(), fileOne.getHeight()));
    }
