...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage leftt = HorizontalRepeatGenerator.get(15, ImageIO.read(new File("d/2/in/design1/border/left.bmp")));
        BufferedImage left = CutLayoutGenerator.get(CutLayoutGenerator.get(leftt, 180, 1), pallu.getWidth(), 0);

        BufferedImage rightt = HorizontalRepeatGenerator.get(15, ImageIO.read(new File("d/2/in/design1/border/right.bmp")));
