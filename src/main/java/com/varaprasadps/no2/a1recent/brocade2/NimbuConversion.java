...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/1recent/2nimbu-%s-%s.bmp";

        final BufferedImage body = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/2/1recent/brocade2/JARI.bmp")));
