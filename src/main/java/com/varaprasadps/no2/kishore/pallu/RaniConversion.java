package com.varaprasadps.no2.kishore.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/kishore/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/2/kishore/pallu/pallu-rani.bmp"));
        int width = pallu.getWidth();
        final BufferedImage left = VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/2/kishore/pallu/pallu-left.bmp")));
        final BufferedImage right = ImageIO.read(new File("z-data/in/2/kishore/pallu/pallu-right.bmp"));
