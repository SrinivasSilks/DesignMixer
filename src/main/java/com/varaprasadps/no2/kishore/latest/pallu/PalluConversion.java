...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/kishore/latest/pallu-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-data/out/2/kishore/latest/p-rani-2000-2688.bmp");
        inputs.add("z-data/out/2/kishore/latest/p-jari-2000-2688.bmp");
