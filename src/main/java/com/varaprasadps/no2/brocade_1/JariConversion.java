...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/1_jari-%s-%s.bmp";
        final BufferedImage skirt = ImageIO.read(new File("z-data/in/2/SKIRT_JARI.bmp"));
        ...
        inputBIs.add(HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/2/1JARI.bmp"))));
        inputBIs.add(skirt);
