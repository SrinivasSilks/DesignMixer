...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/1_nimbu-%s-%s.bmp";
        final BufferedImage skirt = ImageIO.read(new File("z-data/in/2/SKIRT_NIMBU.bmp"));
        ...
        inputBIs.add(HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/2/1NIMBU.bmp"))));
        inputBIs.add(skirt);
