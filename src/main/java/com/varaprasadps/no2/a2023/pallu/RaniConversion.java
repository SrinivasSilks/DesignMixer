package com.varaprasadps.no2.a2023.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage leftt = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-data/in/2/a2023/design1/border/left.bmp")));
        BufferedImage left = CutLayoutGenerator.get(CutLayoutGenerator.get(leftt, 160, 1), pallu.getWidth(), 0);

        BufferedImage rightt = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/2/a2023/design1/border/right.bmp")));
