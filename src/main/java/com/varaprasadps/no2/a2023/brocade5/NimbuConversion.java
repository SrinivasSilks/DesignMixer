...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2023/design1/5nimbu-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(9, ImageIO.read(new File("z-data/in/2/a2023/design1/brocade5/jari.bmp")));
