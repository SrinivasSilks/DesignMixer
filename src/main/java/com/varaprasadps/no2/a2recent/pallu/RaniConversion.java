package com.varaprasadps.no2.a2recent.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/2recent/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/2/2recent/pallu/pallu-rani.bmp"));
        int width = pallu.getWidth();
        final BufferedImage left = ImageIO.read(new File("z-data/in/2/2recent/palluborder/left.bmp"));
        final BufferedImage right = ImageIO.read(new File("z-data/in/2/2recent/palluborder/right.bmp"));
