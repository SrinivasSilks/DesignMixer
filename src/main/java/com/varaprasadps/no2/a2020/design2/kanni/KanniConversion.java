...
public class KanniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2020/design2/kanni-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-data/out/2/a2020/design2/k-rani-600-2688.bmp");
        inputs.add("z-data/out/2/a2020/design2/k-jari-600-2688.bmp");
