...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2020/design2/pallu-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-data/out/2/a2020/design2/p-rani-2000-2688.bmp");
        inputs.add("z-data/out/2/a2020/design2/p-jari-2000-2688.bmp");
