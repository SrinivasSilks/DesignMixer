package com.varaprasadps.no2.a2020.design3.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2020/design3/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/2/a2020/design1/pallu/pallu-rani.bmp"));
        int width = pallu.getWidth();

        final BufferedImage leftTest = HorizontalRepeatGenerator.get(7, VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/2/a2020/design3/border/left.bmp"))));
        final BufferedImage rightTest = HorizontalRepeatGenerator.get(7, ImageIO.read(new File("z-data/in/2/a2020/design3/border/right.bmp")));
