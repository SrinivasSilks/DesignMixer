package com.varaprasadps.no2.a2021.design2.brocade1;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2021/design2/1rani-%s-%s.bmp";

        final BufferedImage leftt = HorizontalRepeatGenerator.get(6, VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/2/a2021/design2/border/left.bmp"))));
        final BufferedImage rightt = HorizontalRepeatGenerator.get(6, ImageIO.read(new File("z-data/in/2/a2021/design2/border/right.bmp")));
