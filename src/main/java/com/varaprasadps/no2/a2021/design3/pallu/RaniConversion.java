package com.varaprasadps.no2.a2021.design3.pallu;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2021/design3/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-data/in/2/a2021/design3/pallu/pallu-rani.bmp"));
        int width = pallu.getWidth();

        BufferedImage leftt = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-data/in/2/a2021/design3/border/left.bmp")));
        BufferedImage left = CutLayoutGenerator.get(leftt, pallu.getWidth(), 0);

        BufferedImage rightt = HorizontalRepeatGenerator.get(10, ImageIO.read(new File("z-data/in/2/a2021/design3/border/right.bmp")));
