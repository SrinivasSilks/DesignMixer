...
public class ThreePlayConversion {

    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage nimbu, BufferedImage jari) throws IOException {
        List<BufferedImage> brocades = new LinkedList<>();
        brocades.add(rani(right, left, rani));
        brocades.add(jari(empty(right.getWidth(), 624), empty(right.getWidth(), 416), nimbu));
        brocades.add(nimbu(empty(right.getWidth(), 624), empty(right.getWidth(), 416), jari));
        return LeftLayoutGenerator.get(getBrocade(brocades));
    }

    public static BufferedImage nimbu(BufferedImage right, BufferedImage left, BufferedImage jari) throws IOException {
    ...
    private static BufferedImage jari(BufferedImage right, BufferedImage left, BufferedImage nimbu) {
        int width = right.getWidth();
    ...
    private static BufferedImage rani(BufferedImage right, BufferedImage left, BufferedImage rani) {
