...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/a2021/design1/1nimbu-%s-%s.bmp";

        final BufferedImage brocade = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-data/in/2/a2021/design1/brocade/jari.bmp")));
