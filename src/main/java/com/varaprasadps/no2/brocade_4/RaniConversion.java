package com.varaprasadps.no2.brocade_4;
...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/2/4_rani-%s-%s.bmp";
        final BufferedImage skirt = ImageIO.read(new File("z-data/in/2/4/B_RANI.bmp"));
        ...
        // Jari
        inputBIs.add(HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/1/SUNUNDA.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/1/BANARAS.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(12, ImageIO.read(new File("z-data/in/1/TEEGA.bmp"))));
