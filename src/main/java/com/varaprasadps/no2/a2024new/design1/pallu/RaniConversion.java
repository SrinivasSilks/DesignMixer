...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/2/out/2024/design1/p-rani-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("d/2/in/2024/design1/pallu/pallu-rani.bmp"));
        int width = pallu.getWidth();

        BufferedImage leftt = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/2/in/2024/design1/border/left.bmp")));
        BufferedImage left = CutLayoutGenerator.get(CutLayoutGenerator.get(leftt, 180, 1), pallu.getWidth(), 0);

        BufferedImage rightt = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/2/in/2024/design1/border/right.bmp")));
