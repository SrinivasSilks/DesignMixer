...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/2/out/2024/design1/3kbrc1-rani-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("d/2/in/2024/design1/border/right.bmp")));
        BufferedImage leftBack = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(5, ImageIO.read(new File("d/2/in/2024/design1/border/left-first.bmp"))));
