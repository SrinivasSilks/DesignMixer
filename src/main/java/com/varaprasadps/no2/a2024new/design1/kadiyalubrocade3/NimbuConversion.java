...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/2/out/2024/design1/3kbrc1-nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(6, ImageIO.read(new File("d/2/in/2024/design1/brocade3/jari.bmp")));
