...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-dinesh/nimbu-%s-%s.bmp";

        final BufferedImage body = PlainGenerator.get(100, 960);
        final BufferedImage border = EmptyGenerator.get(100, 670);
        ...
        // Box
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(body.getWidth(), 5)));
