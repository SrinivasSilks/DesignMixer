...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/2024/design2/1self-jari-%s-%s.bmp";

        final BufferedImage body = HorizontalRepeatGenerator.get(17, ImageIO.read(new File("d/1/in/2024/design2/brocade1/jari.bmp")));
