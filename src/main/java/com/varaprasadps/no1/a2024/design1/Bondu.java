...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage pallu = VerticalFlipGenerator.get(ImageIO.read(new File("d/1/out/2024/design1/pallu-2688-3260.bmp")));
//        BufferedImage brocade = VerticalFlipGenerator.get(ImageIO.read(new File("d/1/out/2024/design1/")));
        BufferedImage kanni = VerticalFlipGenerator.get(ImageIO.read(new File("d/1/out/2024/design1/kanni-2688-480.bmp")));
        BufferedImage kongu = VerticalFlipGenerator.get(ImageIO.read(new File("d/1/out/2024/design1/1kongu-2-2688.bmp")));
