...
public class SelfBrocade1 {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/2024/design1/1selfbrocade-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("d/1/out/2024/design1/1self-rani-1200-2688.bmp");
        inputs.add("d/1/out/2024/design1/1self-jari-1200-2688.bmp");
