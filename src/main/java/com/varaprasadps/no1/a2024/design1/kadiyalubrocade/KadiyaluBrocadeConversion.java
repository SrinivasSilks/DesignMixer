...
public class KadiyaluBrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/2024/design1/kadiyalu/1kadiyalu-brc-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("d/1/out/2024/design1/kadiyalu/1rani-240-2688.bmp");
        inputs.add("d/1/out/2024/design1/kadiyalu/1jari-240-2688.bmp");
        inputs.add("d/1/out/2024/design1/kadiyalu/1nimbu-240-2688.bmp");
