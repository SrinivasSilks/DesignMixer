...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/2024/design1/2self-rani-%s-%s.bmp";

        BufferedImage border = HorizontalRepeatGenerator.get(11, ImageIO.read(new File("d/1/in/2024/design1/border/border.bmp")));
