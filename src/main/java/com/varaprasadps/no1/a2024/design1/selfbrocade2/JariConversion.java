...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/2024/design1/2self-jari-%s-%s.bmp";

        final BufferedImage body = HorizontalRepeatGenerator.get(20, ImageIO.read(new File("d/1/in/2024/design1/brocade2/jari.bmp")));
