...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/2024/design1/1self-rani-%s-%s.bmp";

        BufferedImage border = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("d/1/in/2024/design1/border/border.bmp")));
