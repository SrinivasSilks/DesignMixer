...
public class KadiyaluBrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/design1/kadiyalu/1kadiyalu-brc-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("d/1/out/design1/kadiyalu/1rani-8880-2688.bmp");
        inputs.add("d/1/out/design1/kadiyalu/1jari-8880-2688.bmp");
        inputs.add("d/1/out/design1/kadiyalu/1nimbu-8880-2688.bmp");
