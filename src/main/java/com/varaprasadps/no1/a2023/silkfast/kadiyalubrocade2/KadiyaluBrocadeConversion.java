...
public class KadiyaluBrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/design1/kadiyalu/2kadiyalu-brc-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("d/1/out/design1/kadiyalu/2rani-1200-2688.bmp");
        inputs.add("d/1/out/design1/kadiyalu/2jari-1200-2688.bmp");
        inputs.add("d/1/out/design1/kadiyalu/2nimbu-1200-2688.bmp");
