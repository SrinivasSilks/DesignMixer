...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/a2023/design1/pallu-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-data/out/1/a2023/design1/p-rani-1740-2688.bmp");
        inputs.add("z-data/out/1/a2023/design1/p-jari-1740-2688.bmp");
