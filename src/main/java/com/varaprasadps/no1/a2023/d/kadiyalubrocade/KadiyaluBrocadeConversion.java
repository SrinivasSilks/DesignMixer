...
public class KadiyaluBrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        inputs.add("d/1/out/design1/kadiyalu/1rani-720-2688.bmp");
        inputs.add("d/1/out/design1/kadiyalu/1jari-720-2688.bmp");
        inputs.add("d/1/out/design1/kadiyalu/1nimbu-720-2688.bmp");
