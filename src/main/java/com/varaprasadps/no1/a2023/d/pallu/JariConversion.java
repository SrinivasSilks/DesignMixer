package com.varaprasadps.no1.a2023.d.pallu;
...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/design1/p-jari-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("d/1/in/design1/pallu/pallu-jari.bmp"));
        ...
        inputBIs.add(CutLayoutGenerator.get(pallu, pallu.getHeight() - 156  - 480).get(1));
        inputBIs.add(pallu);
