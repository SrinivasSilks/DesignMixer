...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/1/out/design1/kadiyalu/1nimbu-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/1/in/design1/brocade/jari.bmp")));
