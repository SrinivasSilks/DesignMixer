...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/recent/1rani-%s-%s.bmp";

        final BufferedImage left = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/1/recent/kinda/1left.bmp")));
        final BufferedImage right = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/1/recent/kinda/a1right.bmp")));
