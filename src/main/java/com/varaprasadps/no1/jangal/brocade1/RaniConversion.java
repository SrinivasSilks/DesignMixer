...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/j_1_rani-%s-%s.bmp";
        final BufferedImage skirt = ImageIO.read(new File("z-data/in/1/jangla/1/RANI.bmp"));
        ...
        // Jari
        inputBIs.add(HorizontalRepeatGenerator.get(16, ImageIO.read(new File("z-data/in/1/SUNUNDA.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(16, ImageIO.read(new File("z-data/in/1/BANARAS.bmp"))));
        inputBIs.add(HorizontalRepeatGenerator.get(16, ImageIO.read(new File("z-data/in/1/TEEGA.bmp"))));
