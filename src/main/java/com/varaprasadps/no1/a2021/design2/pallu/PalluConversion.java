...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/a2021/design2/pallu-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-data/out/1/a2021/design2/p-rani-1900-2688.bmp");
        inputs.add("z-data/out/1/a2021/design2/p-jari-1900-2688.bmp");
