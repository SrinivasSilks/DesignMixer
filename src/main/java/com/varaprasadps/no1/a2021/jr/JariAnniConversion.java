...
public class JariAnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/a2021/jr/jari-anni-%s-%s.bmp";

        List<BufferedImage> inputBIs = new LinkedList<>();

        final BufferedImage left = PlainGenerator.get(20, 384);
        final BufferedImage right = PlainGenerator.get(20, 1280);
