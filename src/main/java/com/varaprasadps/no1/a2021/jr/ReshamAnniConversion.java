...
public class ReshamAnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/a2021/jr/resham-anni-%s-%s.bmp";

        List<BufferedImage> inputBIs = new LinkedList<>();

        final BufferedImage left = EmptyGenerator.get(20, 384);
        final BufferedImage right = EmptyGenerator.get(20, 1280);
