...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/D1/L1-jari-%s-%s.bmp";

        final BufferedImage skirt = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/1/D1/brocade/JARI.bmp")));
