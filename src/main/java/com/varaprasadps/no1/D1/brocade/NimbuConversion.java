...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/D1/L1-nimbu-%s-%s.bmp";
        final BufferedImage skirt = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/1/D1/brocade/NIMBU.bmp")));
        ...
        // Empty Skirt
        inputBIs.add(EmptyGenerator.get(skirt.getWidth(), 1190));
