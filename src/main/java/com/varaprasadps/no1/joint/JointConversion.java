package com.varaprasadps.no1.joint;
...
public class JointConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/1joint-%s-%s.bmp";
        ...
        // Locking
        // All over
        inputBIs.add(EmptyGenerator.get(width, 500));

        // Skirt
        inputBIs.add(EmptyGenerator.get(width, 1200));

        inputBIs.add(PlainGenerator.get(width, 60));
