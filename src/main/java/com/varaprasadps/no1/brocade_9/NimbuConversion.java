package com.varaprasadps.no1.brocade_9;
...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/9_nimbu-%s-%s.bmp";
        final BufferedImage skirt = HorizontalFlipGenerator.get(ImageIO.read(new File("z-data/in/1/9/NIMBU.bmp")));
        ...
        inputBIs.add(CutLayoutGenerator.get(skirt, 1656).get(0));

        inputBIs.add(ReverseGenerator.get(PlainGenerator.get(skirt.getWidth(), 24)));
        // Jari
