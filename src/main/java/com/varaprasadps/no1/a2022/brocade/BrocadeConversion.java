...
public class BrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/1/a2022/1brocade-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-data/out/1/a2022/1rani-480-2688.bmp");
        inputs.add("z-data/out/1/a2022/1jari-480-2688.bmp");
        inputs.add("z-data/out/1/a2022/1nimbu-480-2688.bmp");
