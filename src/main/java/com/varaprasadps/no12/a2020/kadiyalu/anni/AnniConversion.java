package com.varaprasadps.no12.a2020.kadiyalu.anni;
...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2020/k/anni-%s-%s.bmp";

        BufferedImage border = ReverseGenerator.get(ImageIO.read(new File("z-data/in/12/a2020/border/right.bmp")));
