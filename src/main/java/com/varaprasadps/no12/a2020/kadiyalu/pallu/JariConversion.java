...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2020/k/p-jari-%s-%s.bmp";

        BufferedImage body = ReverseGenerator.get(VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/12/a2020/pallu2/pallu-jari.bmp"))));
