package com.varaprasadps.no12.a1recent;
...
public class BorderGenerator {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/in/12/a1recent/border/border.bmp";

        BufferedImage right = ImageIO.read(new File("z-data/in/12/a1recent/border/42.bmp"));
        ...
        inputBIs.add(bugada);
        inputBIs.add(teega);
        inputBIs.add(CutLayoutGenerator.get(StepLayoutGenerator.get(right.getWidth(), 44, 5), 216).get(0));
        inputBIs.add(teega);
        inputBIs.add(figure);
        inputBIs.add(teega);
