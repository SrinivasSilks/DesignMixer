package com.varaprasadps.no12.a2020oct.design2.anni;
...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2020oct/design2/anni-%s-%s.bmp";

        BufferedImage border = ImageIO.read(new File("z-data/in/12/a2020oct/design2/border/right.bmp"));
