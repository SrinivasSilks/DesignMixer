package com.varaprasadps.no12.a2024new.design1.kadiyalubroc1;
...
public class KadiyaluGoldConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/2024/design1/1kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage jari = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/12/in/2024/design1/brocade1/silver.bmp")));
        BufferedImage meena = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/12/in/2024/design1/brocade1/meena.bmp")));
