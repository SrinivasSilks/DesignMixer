package com.varaprasadps.no12.a2024new.design1.kadiyaluanni;
...
public class KadiyaluGoldConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/2024/design1/1kadiyalu-anni-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
