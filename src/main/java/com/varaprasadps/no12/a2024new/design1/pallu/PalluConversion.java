package com.varaprasadps.no12.a2024new.design1.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/2024/design1/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage meena = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/12/in/2024/design1/pallu/pallu-rani.bmp")));
        BufferedImage jari = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/12/in/2024/design1/pallu/pallu-jari.bmp")));

        BufferedImage rightd = ImageIO.read(new File("d/12/in/2024/design1/border/right.bmp"));
        BufferedImage leftd = ImageIO.read(new File("d/12/in/2024/design1/border/left.bmp"));
