package com.varaprasadps.no12.a2024new.design1.blouse;
...
public class BlouseConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/2024/design1/blouse-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage left = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/12/in/2024/design1/border/left.bmp")));
        BufferedImage right = ImageIO.read(new File("d/12/in/2024/design1/border/right.bmp"));
        BufferedImage meena = HorizontalRepeatGenerator.get(left.getWidth() / 20, ImageIO.read(new File("d/12/in/2024/design1/blouse/jari.bmp")));
        BufferedImage jari = HorizontalRepeatGenerator.get(left.getWidth() / 20, ImageIO.read(new File("d/12/in/2024/design1/blouse/rani.bmp")));
