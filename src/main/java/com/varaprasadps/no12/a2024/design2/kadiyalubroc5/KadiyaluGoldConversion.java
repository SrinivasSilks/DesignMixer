package com.varaprasadps.no12.a2024.design2.kadiyalubroc5;
...
public class KadiyaluGoldConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage body) throws IOException {
        ...
        brocades.add(jari(right, left, PlainGenerator.get(body.getWidth(), body.getHeight())));
        ...
        saveBMP(brocade, format("d/12/out/design2/5kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage jari = HorizontalRepeatGenerator.get(12, ImageIO.read(new File("d/12/in/design2/brocade5/gold.bmp")));
