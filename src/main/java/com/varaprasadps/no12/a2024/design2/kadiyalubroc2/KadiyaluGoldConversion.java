package com.varaprasadps.no12.a2024.design2.kadiyalubroc2;
...
public class KadiyaluGoldConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/design2/2kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage jari = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/12/in/design2/brocade2/silver.bmp")));
        BufferedImage meena = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("d/12/in/design2/brocade2/meena.bmp")));
