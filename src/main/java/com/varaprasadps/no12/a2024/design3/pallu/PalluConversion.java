package com.varaprasadps.no12.a2024.design3.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/design3/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage meena = ImageIO.read(new File("d/12/in/design3/pallu/pallu-rani.bmp"));
        BufferedImage jari = ImageIO.read(new File("d/12/in/design3/pallu/pallu-silver.bmp"));


        BufferedImage leftf = HorizontalRepeatGenerator.get(15, ImageIO.read(new File("d/12/in/design3/border/left.bmp")));
        BufferedImage rightf = HorizontalRepeatGenerator.get(15, ImageIO.read(new File("d/12/in/design3/border/right.bmp")));

        BufferedImage left = CutLayoutGenerator.get(leftf, meena.getWidth(), 0);
        BufferedImage right = CutLayoutGenerator.get(rightf, meena.getWidth(), 0);
