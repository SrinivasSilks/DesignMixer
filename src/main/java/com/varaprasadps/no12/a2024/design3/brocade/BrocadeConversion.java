package com.varaprasadps.no12.a2024.design3.brocade;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage meena, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("d/12/out/design3/1brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {

        BufferedImage left = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("d/12/in/design3/border/left.bmp")));
        BufferedImage right = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("d/12/in/design3/border/right.bmp")));
        BufferedImage jari = VerticalRepeatGenerator.get(2, ImageIO.read(new File("d/12/in/design3/brocade/silver.bmp")));
