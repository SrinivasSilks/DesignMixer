package com.varaprasadps.no12.a2022.own.a2.brocade4;
...
public class KadiyaluGoldConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage leftback, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-data/out/12/a2022/own/2/4kbroc-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(final String[] args) throws IOException {
        ...
        BufferedImage gold = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-data/in/12/a2022/own/2/brocade4/jari.bmp")));
