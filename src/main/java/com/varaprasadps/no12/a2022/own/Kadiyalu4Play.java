package com.varaprasadps.no12.a2022.own;
...
public class Kadiyalu4Play {

    public static BufferedImage meena(BufferedImage right, BufferedImage left, BufferedImage silver) {
        ...
        inputBIs.add(silver);
        //locking
        inputBIs.add(CutLayoutGenerator.get(silver, 8).get(0));
    ...
    public static BufferedImage nimbu(BufferedImage right, BufferedImage left, BufferedImage gold) {
        ...
        inputBIs.add(gold);
        //locking
        inputBIs.add(CutLayoutGenerator.get(gold, 8).get(0));
        inputBIs.add(PlainGenerator.get(width, 4));
