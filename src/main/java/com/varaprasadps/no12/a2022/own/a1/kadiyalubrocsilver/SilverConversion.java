...
public class SilverConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2022/own/1/kadiyalusilver/kbroc-silver-%s-%s.bmp";
        ...
        BufferedImage body = HorizontalRepeatGenerator.get(16, ImageIO.read(new File("z-data/in/12/a2022/own/1/brocade3/silver.bmp")));
