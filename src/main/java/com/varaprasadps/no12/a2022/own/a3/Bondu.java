package com.varaprasadps.no12.a2022.own.a3;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/12/a2022/own/3/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-data/out/12/a2022/own/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/12/a2022/own/3/kanni-1824-480.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-data/out/12/a2022/own/3/anni-240-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/12/a2022/own/3/pallu-1824-3412.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/12/a2022/own/3/kadiyalubroc/kbroc-1824-3600.bmp"));
