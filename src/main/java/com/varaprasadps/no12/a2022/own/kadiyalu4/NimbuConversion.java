...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2022/own/kadiyalubroc4/kbroc-nimbu-%s-%s.bmp";
        ...
        BufferedImage body = HorizontalRepeatGenerator.get(5, ImageIO.read(new File("z-data/in/12/a2022/design1/brocade/gold.bmp")));
