package com.varaprasadps.no12.a2022.own.a1.kanni;
...
public class KanniConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-data/out/12/a2022/own/1/kanni-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage right = ImageIO.read(new File("z-data/in/12/a2022/own/1/border/right.bmp"));
        BufferedImage left = VerticalFlipGenerator.get(ImageIO.read(new File("z-data/in/12/a2022/own/1/border/right.bmp")));
