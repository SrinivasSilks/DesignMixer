...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2022/own/2/kadiyalubroc/2kbroc-jari-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("z-data/in/12/a2022/own/2/border/right.bmp")));
        BufferedImage left = VerticalFlipGenerator.get(HorizontalRepeatGenerator.get(8, ImageIO.read(new File("z-data/in/12/a2022/own/2/border/left.bmp"))));
