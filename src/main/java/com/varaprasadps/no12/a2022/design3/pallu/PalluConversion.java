package com.varaprasadps.no12.a2022.design3.pallu;
...
public class PalluConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage rani, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, format("z-data/out/12/a2022/design3/pallu-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }

    public static void main(final String[] args) throws IOException {
        BufferedImage rightd = ImageIO.read(new File("z-data/in/12/a2021/design3/border/border.bmp"));
        ...
        BufferedImage rani = ImageIO.read(new File("z-data/in/12/a2021/design3/pallu/p-rani.bmp"));
        BufferedImage jari = ImageIO.read(new File("z-data/in/12/a2021/design3/pallu/p-jari.bmp"));
