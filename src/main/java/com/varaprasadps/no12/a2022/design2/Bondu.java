package com.varaprasadps.no12.a2022.design2;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/12/a2022/design2/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-data/out/12/a2022/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/12/a2022/design2/kanni-1824-960.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-data/out/12/a2022/design2/anni-480-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/12/a2022/design2/pallu-1824-4000.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/12/a2022/design2/brocade-1824-1440.bmp"));
