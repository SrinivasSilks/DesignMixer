package com.varaprasadps.no12.a2021.design4;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/12/a2021/design4/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-data/out/12/a2021/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/12/a2021/design4/kanni-1824-2560.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-data/out/12/a2021/design4/anni-1280-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/12/a2021/design4/pallu-1824-4000.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/12/a2021/design4/brocade-1824-3840.bmp"));
