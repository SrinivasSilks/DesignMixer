package com.varaprasadps.no12.a2021.design4.brocade;
...
public class BrocadeConversion {
    ...
    public static BufferedImage get(BufferedImage right, BufferedImage left, BufferedImage nimbu, BufferedImage jari) throws IOException {
        ...
        saveBMP(brocade, String.format("z-data/out/12/a2021/design4/brocade-%s-%s.bmp", brocade.getWidth(), brocade.getHeight()));
        return brocade;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage nimbu = HorizontalRepeatGenerator.get(1, ImageIO.read(new File("z-data/in/12/a2021/design4/brocade/nimbu.bmp")));
