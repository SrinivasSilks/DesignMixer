package com.varaprasadps.no12.a2021.design1.anni;
...
public class BlouseConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/12/a2021/design1/blouse-%s-%s.bmp";

        BufferedImage border = ImageIO.read(new File("z-data/in/12/a2021/design1/border/border.bmp"));
        BufferedImage blouse = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-data/in/12/a2021/design1/blouse.bmp")));
