package com.varaprasadps.no11.a2021;
...
public class BorderAnniConversion {

    public static void main(final String[] args) throws IOException {

        String out = "z-data/out/11/a2021/jr/border-anni-%s-%s.bmp";

        BufferedImage border = PlainGenerator.get(20, 800);
