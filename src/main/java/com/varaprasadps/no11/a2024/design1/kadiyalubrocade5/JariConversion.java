...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/11/out/a2024/design1/5k-jari-%s-%s.bmp";
        ...
        BufferedImage body = HorizontalRepeatGenerator.get(6, ImageIO.read(new File("d/11/in/a2024/design1/brocade5/silver.bmp")));
