...
public class RaniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/11/out/a2024/design1/3kbrc-rani-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/11/in/a2024/design1/border/right.bmp")));
        BufferedImage left = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("d/11/in/a2024/design1/border/left-first.bmp")));
