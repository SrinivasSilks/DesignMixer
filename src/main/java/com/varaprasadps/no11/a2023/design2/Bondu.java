package com.varaprasadps.no11.a2023.design2;
...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "d/11/out/design2/kongu.bmp";

        BufferedImage blouse = ImageIO.read(new File("d/11/out/design2/blouse-1824-720.bmp"));
        BufferedImage pallu = ImageIO.read(new File("d/11/out/design2/pallu-1824-3260.bmp"));
