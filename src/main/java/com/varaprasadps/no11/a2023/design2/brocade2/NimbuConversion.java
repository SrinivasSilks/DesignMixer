...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/11/out/design2/2nimbu-%s-%s.bmp";

        BufferedImage brocade = HorizontalRepeatGenerator.get(18, ImageIO.read(new File("d/11/in/design2/brocade2/silver.bmp")));
