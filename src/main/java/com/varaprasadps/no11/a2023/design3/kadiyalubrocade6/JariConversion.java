...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/11/out/design3/6kbrc-jari-%s-%s.bmp";
        ...
        BufferedImage body = HorizontalRepeatGenerator.get(4, ImageIO.read(new File("d/11/in/design3/brocade6/silver.bmp")));
