...
public class GoldConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "d/11/out/design3/4gold-%s-%s.bmp";

        BufferedImage brocade = HorizontalRepeatGenerator.get(8, ImageIO.read(new File("d/11/in/design3/brocade4/anni.bmp")));
        ...
        //right
        inputBIs.add(ReverseGenerator.get(EmptyGenerator.get(width, 590)));
