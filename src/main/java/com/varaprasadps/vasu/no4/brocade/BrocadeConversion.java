...
public class BrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/4/test/brocade-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-vasu/out/4/test/rani-8160-1792.bmp");
        inputs.add("z-vasu/out/4/test/nimbu-8160-1792.bmp");
        inputs.add("z-vasu/out/4/test/jari-8160-1792.bmp");
