...
public class BrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/4/test/3brocade-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-vasu/out/4/test/3rani-2040-1792.bmp");
        inputs.add("z-vasu/out/4/test/3nimbu-2040-1792.bmp");
        inputs.add("z-vasu/out/4/test/3jari-2040-1792.bmp");
