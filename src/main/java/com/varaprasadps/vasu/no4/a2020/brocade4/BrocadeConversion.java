...
public class BrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/4/a2020/4brocade-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-vasu/out/4/a2020/4rani-4620-1792.bmp");
        inputs.add("z-vasu/out/4/a2020/4nimbu-4620-1792.bmp");
        inputs.add("z-vasu/out/4/a2020/4jari-4620-1792.bmp");
