package com.varaprasadps.vasu.no4.a2020.anni;
...
public class AnniConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/4/a2020/plain-%s-%s.bmp";

        final BufferedImage border = ImageIO.read(new File("z-vasu/in/4/a2020/border.bmp"));
