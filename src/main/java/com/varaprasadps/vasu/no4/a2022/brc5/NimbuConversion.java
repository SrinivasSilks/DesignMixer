...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/4/a2022/5broc-nimbu-%s-%s.bmp";

        final BufferedImage border = HorizontalRepeatGenerator.get(10, EmptyGenerator.get(240, 400));

        int width = border.getWidth();
        final BufferedImage brocade = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-vasu/in/4/a2022/brocade5/jari.bmp")));
