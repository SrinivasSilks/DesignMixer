package com.varaprasadps.vasu.no4.jr.design1.blouse;
...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/4/jr/design1/blouse-jari-%s-%s.bmp";

        final BufferedImage pallu = ImageIO.read(new File("z-vasu/in/4/jr/design1/blouse/jari.bmp"));
