...
public class BrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/2/brocade-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-vasu/out/2/rani-1200-1792.bmp");
        inputs.add("z-vasu/out/2/jari-1200-1792.bmp");
        inputs.add("z-vasu/out/2/nimbu-1200-1792.bmp");
