package com.varaprasadps.vasu.no3.design4;
...
public class BorderConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/3/design4/V5BORDER.bmp";

        final BufferedImage border = HorizontalFlipGenerator.get(ImageIO.read(new File("z-vasu/in/3/design4/border.bmp")));
