...
public class BlouseConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/5/a2021/design1/CR5BLOUSE1.bmp";

        final BufferedImage blouse = ReverseGenerator.get(ImageIO.read(new File("z-vasu/in/5/a2021/design1/blouse.bmp")));
