...
public class BorderConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-vasu/out/5/design1/L5BORDER.bmp";

        final BufferedImage border = ReverseGenerator.get(ImageIO.read(new File("z-vasu/in/5/design1/border/border.bmp")));
