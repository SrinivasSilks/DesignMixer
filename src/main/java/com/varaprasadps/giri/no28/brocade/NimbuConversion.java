...
public class NimbuConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-giri/out/28/nimbu-%s-%s.bmp";

        final BufferedImage skirt = ImageIO.read(new File("z-giri/in/28/S_NIMBU.bmp"));
        final BufferedImage allover = ImageIO.read(new File("z-giri/in/28/A_NIMBU.bmp"));
