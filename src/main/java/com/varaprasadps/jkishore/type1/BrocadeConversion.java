...
public class BrocadeConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        inputs.add("z-data/in/kishore/1rani-480-2048.bmp");
        inputs.add("z-data/in/kishore/1jari-480-2048.bmp");
        inputs.add("z-data/in/kishore/1nimbu-480-2048.bmp");
        ...
        displayPixels(bi);
        String out = "z-data/in/kishore/1brocade-%s-%s.bmp";
        saveBMP(bi, String.format(out, bi.getWidth(), bi.getHeight()));

        BufferedImage test = LeftLayoutGenerator.get(ColumnRepeatGenerator.get(inputBIs));
        displayPixels(test);
        String out2 = "z-data/in/kishore/2brocade-%s-%s.bmp";
