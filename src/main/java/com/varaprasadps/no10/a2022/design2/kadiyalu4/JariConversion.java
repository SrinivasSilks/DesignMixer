...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/10/a2022/design2/kadiyalubroc4/kbroc-jari-%s-%s.bmp";

        BufferedImage right = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-data/in/10/a2022/design2/border/right.bmp")));
        BufferedImage left = HorizontalRepeatGenerator.get(2, ImageIO.read(new File("z-data/in/10/a2022/design2/border/left.bmp")));
