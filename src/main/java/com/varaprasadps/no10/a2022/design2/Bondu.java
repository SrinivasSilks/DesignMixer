...
public class Bondu {
    ...
    public static void main(final String[] args) throws IOException {
        String out = "z-data/out/10/a2022/design2/pset.bmp";

        BufferedImage kongu = ImageIO.read(new File("z-data/out/10/a2022/design1/kongu-2-1824.bmp"));
        BufferedImage kanni = ImageIO.read(new File("z-data/out/10/a2022/design2/kanni-1824-480.bmp"));
        BufferedImage anni = ImageIO.read(new File("z-data/out/10/a2022/design2/anni-240-1824.bmp"));
        BufferedImage pallu = ImageIO.read(new File("z-data/out/10/a2022/design2/pallu-1824-3600.bmp"));
        BufferedImage brocade = ImageIO.read(new File("z-data/out/10/a2022/design2/kadiyalubroc4/4kbroc-1824-1920.bmp"));
