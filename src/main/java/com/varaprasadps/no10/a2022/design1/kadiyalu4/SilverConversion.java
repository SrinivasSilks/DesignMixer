...
public class SilverConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/10/a2022/design1/kadiyalubroc4/kbroc-silver-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(3, ImageIO.read(new File("z-data/in/10/a2022/design1/brocade3/silver.bmp")));
