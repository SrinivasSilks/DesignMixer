...
public class JariConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/10/a2021/jr/design1/blouse-jari-%s-%s.bmp";

        BufferedImage body = HorizontalRepeatGenerator.get(20, ImageIO.read(new File("z-data/in/10/a2021/jr/design1/blouse/jari.bmp")));
