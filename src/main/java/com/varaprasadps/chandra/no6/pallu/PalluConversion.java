...
public class PalluConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-chandra/out/6/design1/pallu-%s-%s.bmp";

        List<String> inputs = new LinkedList<>();
        inputs.add("z-chandra/out/6/design1/p-rani-1900-1792.bmp");
        inputs.add("z-chandra/out/6/design1/p-jari-1900-1792.bmp");
