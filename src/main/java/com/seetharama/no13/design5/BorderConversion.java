package com.seetharama.no13.design5;
...
public class BorderConversion {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        String out = "z-data/out/13/design5/5BORDER.bmp";

        final BufferedImage border = ImageIO.read(new File("z-data/in/13/design5/border/border.bmp"));
