package com.seetharama.no13.a2022.test.conversions;
...
public class Play12 {
    ...
    public static BufferedImage get(BufferedImage raniBody, BufferedImage rChecks,
                                    BufferedImage silverBody, BufferedImage sChecks) throws IOException {
        List<BufferedImage> inputBIs = new LinkedList<>();
        inputBIs.add(rani(raniBody, rChecks));
        inputBIs.add(silver(silverBody, sChecks));
        return LeftLayoutGenerator.get(ColumnRepeatGenerator.get(inputBIs));
    }

    public static BufferedImage silver(BufferedImage body, BufferedImage checks) {
